...
class CycleError(GraphError):
    ...
    def __init__(self, source_id: UUID, target_id: UUID, **context: Any) -> None:
        super().__init__(
...
class NodeNotFoundError(GraphError):
    ...
    def __init__(self, node_id: UUID, **context: Any) -> None:
...
class EdgeNotFoundError(GraphError):
    ...
    def __init__(self, edge_id: UUID, **context: Any) -> None:
...
class AnnotationNotFoundError(GraphError):
    ...
    def __init__(
        self, target_type: str, target_id: UUID, namespace: str, **context: Any
    ) -> None:
        super().__init__(
...
class DanglingEdgeError(GraphError):
    ...
    def __init__(self, edge_id: UUID, missing_node_id: UUID, **context: Any) -> None:
        super().__init__(
