...
from tests.fixtures.mag_preport import PreportCriterion, ContinuationWorker
from ergon_builtins.benchmarks.manager_gym.inference import INTERNAL_MODEL

OUT = Path(__file__).with_name("continuation-result.json")
    ...
    sample = Sample.from_tasks(
        ...
        tasks=[
            Task(
                ...
                worker=ContinuationWorker(name="proof", actor_key="manager_agent", model=INTERNAL_MODEL),
                sandbox=E2BSandbox(timeout_seconds=1200),
