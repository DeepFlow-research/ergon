...
- Native execution digest: `3a245165d0c69b3f8bd595fda22b19263c2925416bc184967b95cf3687369aea`.
...
- PostgreSQL integration: **three passed**, covering concurrent message ordering,
  nonblocking graph row locks and repeatable message migrations.
...
- Build-v4 delayed cancellation probe:
  `58d26ae8-d81e-4d89-9f82-5f59d779d398` passed all checks. Both running task
  attempts were cancelled, both E2B sandboxes closed, and no delayed child appeared.
- Build-v4 scripted native composition contract:
  `c6b22727-917f-43d9-bb81-d1615d8a6ee9` passed with score 1.0. Seven nodes,
  six completed attempts, one intentional pending cancellation, five messages,
  five retained resources and verified sandbox closure. This is a contract score,
  not an autonomous MAG utility result.
...
8. ICAAP exceeded Inngest's 32 MB aggregate state limit when full observations and
   ...
   The original failed sample is `d50be19e-a0a6-4c67-8523-e8e9caa0860c`.

## Evidence and interpretation

Final autonomous pilot/catalog results, a linked frozen-snapshot reevaluation,
raw export digests and temporary VM teardown receipt are pending.
