...
> See [`02-persistence-and-identity.md`](02-persistence-and-identity.md)
...
[`05-migration.md`](05-migration.md) "What's deferred"). For v1, the
...
matching [`05-migration.md`](05-migration.md). Everything authors,
...
[`05-migration.md`](05-migration.md) "What's deferred").

Legend: **`[P1]`–`[P4]`** = phase from [`05-migration.md`](05-migration.md);
...
│                                    # Decision in 06-decisions-log.md (resolved — re-export pattern rolled back).
│
...
scope creep — see [`05-migration.md`](05-migration.md) "What's
deferred" and [`06-decisions-log.md`](06-decisions-log.md) "Layered
...
class Task(BaseModel, Generic[PayloadT]):
    ...
    # 02-persistence-and-identity.md alongside the other class
...
class Sandbox(BaseModel, ABC):
    ...
    async def run_command(self, cmd: str, timeout: int = 30) -> CommandResult:
        return await self._require_runtime().run_command(cmd, timeout)
    ...
    # ...etc — same surface CriterionRuntime exposes today.
...
[`06-decisions-log.md`](06-decisions-log.md#alternatives-considered)
...
[`06-decisions-log.md#open-questions`](06-decisions-log.md#open-questions)).
...
- **The whole `definition_task_id` / `node_id` / `task_id` confusion
  ...
  [`02-persistence-and-identity.md#identifier-model`](02-persistence-and-identity.md#identifier-model-two-tables-one-identity)).
