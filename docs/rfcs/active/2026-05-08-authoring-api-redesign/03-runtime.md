...
> [`05-migration.md`](05-migration.md) "What's deferred" and
...
> [`02-persistence-and-identity.md`](02-persistence-and-identity.md) for
...
```python
# Inside worker_execute (the canonical path):
...
[`05-migration.md` §14.C](05-migration.md#14c--internal-dto-reshape)). v1
...
[`06-decisions-log.md`](06-decisions-log.md) for what we'd need to see
...
[`06-decisions-log.md#future-work`](06-decisions-log.md#future-work) on
