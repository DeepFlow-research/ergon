...
def _build_task_tree_for_run(
    ...
    Reads RunGraphNode/RunGraphEdge rows for the run.
    ...
    def build(node_id: UUID) -> TaskTreeNode:
        ...
        return TaskTreeNode(
            ...
            assigned_to=_worker_ref_for_slug(node.assigned_worker_slug),
    ...
    return TaskTreeNode(
        ...
        assigned_to=_worker_ref_for_slug(None),
        children=children,
        depends_on=[],
