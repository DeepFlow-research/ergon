...
def create_workflow() -> Workflow:
    ...
    foundation_setup = Task(
        ...
        description="Establish UK corporate structure, appoint nominated postholders, define governance framework, and secure UK principal place of business to meet CAA requirements.",
    ...
    operations_manual = Task(
        ...
        description="Develop comprehensive Operations Manual covering General (OM-A), Aircraft Operating (OM-B), Route & Aerodrome (OM-C), and Training (OM-D) procedures compliant with UK regulations.",
        status=TaskStatus.PENDING,
    ...
    safety_management = Task(
        ...
        description="Implement comprehensive SMS including safety policy, risk management, safety assurance, and safety promotion components meeting ICAO Annex 19 and UK requirements.",
        status=TaskStatus.PENDING,
    ...
    airworthiness_management = Task(
        ...
        description="Establish Part-CAMO arrangements, aircraft registration, maintenance programs, and continuing airworthiness management organization compliance.",
        status=TaskStatus.PENDING,
    ...
    aviation_security = Task(
        ...
        description="Develop airline security programme compliant with NASP, implement staff vetting, security training, and screening equipment arrangements.",
        status=TaskStatus.PENDING,
    ...
    financial_fitness = Task(
        ...
        description="Demonstrate financial fitness for Operating Licence, secure required insurance coverage, and establish financial monitoring and reporting systems.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=8.0,
        estimated_cost=1200.0,
        dependency_task_ids=[foundation_setup.id],
    ...
    airport_operations = Task(
        ...
        description="Secure airport slots, establish ground handling contracts, develop disruption management plans, and ensure compliance with passenger rights regulations.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=10.0,
        estimated_cost=1500.0,
    ...
    aoc_application = Task(
        ...
        description="Submit formal AOC application, conduct proving flights, address CAA inspection findings, and achieve AOC issuance with operational approvals.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=12.0,
        estimated_cost=1800.0,
        dependency_task_ids=[
    ...
    operating_licence = Task(
        ...
        description="Submit Operating Licence application, demonstrate ongoing compliance, obtain final governance approvals, and achieve launch readiness certification.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=8.0,
        estimated_cost=1200.0,
        dependency_task_ids=[financial_fitness.id, airport_operations.id, aoc_application.id],
    )
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                description="Air Operator Certificate must be issued by CAA with no unresolved findings and successful proving flights.",
            ...
            Constraint(
                ...
                description="Operating Licence requires demonstrated financial fitness, UK ownership/control, and compliant insurance.",
                constraint_type="regulatory",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="All aircraft must have valid CofA, ARC, and approved maintenance programs before operations.",
                constraint_type="regulatory",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="SMS must be fully implemented and operational meeting ICAO Annex 19 and UK regulatory requirements.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="Aviation security programme must be approved under NASP with 100% staff vetting and training.",
                constraint_type="regulatory",
                enforcement_level=0.95,
            ...
            Constraint(
                ...
                description="Operations Manual (OM-A/B/C/D) must be approved by CAA and compliant with UK Reg (EU) 965/2012.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="All nominated postholders must be appointed and meet CAA competency and experience requirements.",
                constraint_type="regulatory",
                enforcement_level=0.9,
            ...
            Constraint(
                ...
                description="Airport slots must be confirmed at coordinated airports with valid handling and access arrangements.",
            ...
            Constraint(
                ...
                description="Insurance coverage must meet regulatory minima for passenger, baggage, cargo, and third-party liabilities.",
                constraint_type="regulatory",
                enforcement_level=0.9,
