...
def create_team_configs():
    ...
    flight_operations_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Flight Operations Specialist developing Operations Manual sections (OM-A/B/C/D), flight procedures, crew training programs, and operational control systems.",
    ...
    safety_management_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Safety Management Specialist implementing SMS compliant with ICAO Annex 19, developing safety policy, risk management processes, and safety assurance systems.",
    ...
    airworthiness_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an Airworthiness Manager establishing CAMO arrangements, Part-145 contracts, maintenance programs, and continuing airworthiness management compliance.",
    ...
    aviation_security_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an Aviation Security Specialist developing airline security programmes under NASP, managing staff vetting, security training, and screening equipment arrangements.",
    ...
    regulatory_affairs_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Regulatory Affairs Manager coordinating AOC and Operating Licence applications, managing CAA liaison, inspection support, and regulatory compliance activities.",
    ...
    financial_compliance_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Financial Compliance Analyst preparing financial fitness documentation, securing insurance coverage, and managing financial monitoring systems.",
    ...
    airport_operations_coordinator = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You coordinate airport operations including slot management, ground handling contracts, disruption management plans, and passenger rights compliance.",
    ...
    training_standards_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Training Standards Manager developing OM-D training programs, competency standards, crew checking requirements, and training delivery systems.",
    ...
    continuing_airworthiness_manager = HumanAgentConfig(
        ...
        agent_capabilities=["Oversees CAMO oversight", "Oversees airworthiness compliance"],
    )
...
def create_team_timeline():
    ...
    return {
        0: [
            ("add", cfg["flight_operations_specialist"], "Operations Manual development"),
            ("add", cfg["safety_management_specialist"], "SMS implementation"),
            ("add", cfg["regulatory_affairs_manager"], "Regulatory coordination and foundation"),
        ],
        5: [
            ("add", cfg["airworthiness_manager"], "CAMO and airworthiness arrangements"),
            ("add", cfg["aviation_security_specialist"], "Aviation security programme"),
            ("add", cfg["financial_compliance_analyst"], "Financial fitness and insurance"),
        ],
        10: [
        ...
        30: [("add", cfg["cfo_finance_director"], "Financial fitness validation")],
        35: [("add", cfg["accountable_manager"], "Final accountability and launch approval")],
    }
