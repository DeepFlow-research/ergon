...
def create_brand_crisis_management_team_configs():
    ...
    crisis_communications_lead = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Crisis Communications Lead specializing in messaging framework development, multi-channel communication strategy, and brand voice preservation during crisis situations.",
    ...
    social_media_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Social Media Manager handling real-time social media response, sentiment monitoring, and platform-specific crisis communications with consistency across channels.",
    ...
    stakeholder_relations_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You manage stakeholder relations including customer retention, employee communications, investor relations, and partner notifications during crisis events.",
    ...
    media_relations_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You handle traditional media relations including press releases, journalist relationships, spokesperson coordination, and narrative control efforts.",
    ...
    crisis_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Crisis Analyst conducting situation assessment, stakeholder impact analysis, financial impact quantification, and competitive landscape evaluation.",
    ...
    customer_service_coordinator = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You coordinate customer service enhancement, develop crisis-specific scripts, and implement customer retention and compensation programs.",
    ...
    digital_reputation_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You manage digital reputation recovery including SEO optimization, positive content creation, online review management, and influencer engagement strategies.",
    ...
    crisis_legal_counsel = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You provide legal guidance during crisis including risk assessment, regulatory compliance, documentation requirements, and litigation preparedness.",
...
def create_brand_crisis_management_team_timeline():
    ...
    return {
        0: [
            ("add", cfg["crisis_communications_lead"], "Crisis communications strategy"),
        ...
        2: [
            ...
            ("add", cfg["media_relations_specialist"], "Media relations and press response"),
            ("add", cfg["public_relations_director"], "External communications leadership"),
        ],
        4: [
            ("add", cfg["stakeholder_relations_manager"], "Multi-stakeholder coordination"),
            ("add", cfg["customer_service_coordinator"], "Customer service enhancement"),
        ...
        6: [
            ...
            ("add", cfg["investor_relations_director"], "Investor confidence management"),
