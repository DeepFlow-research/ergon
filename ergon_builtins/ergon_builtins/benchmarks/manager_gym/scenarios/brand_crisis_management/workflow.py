...
def create_brand_crisis_management_workflow() -> Workflow:
    ...
    crisis_assessment = Task(
        ...
        description="Conduct comprehensive crisis situation assessment and stakeholder impact analysis; quantify scope, scale, and immediate threats to brand reputation.",
    ...
    executive_team_activation = Task(
        ...
        description="Activate crisis management team and establish decision-making protocols with 24/7 response capability.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=2.0,
    ...
    immediate_response_strategy = Task(
        ...
        description="Develop initial crisis response strategy and key messaging framework aligned with brand values.",
        status=TaskStatus.PENDING,
    ...
    public_communication_launch = Task(
        ...
        description="Execute initial public communications across all channels with coordinated messaging.",
        status=TaskStatus.PENDING,
    ...
    internal_stakeholder_communication = Task(
        ...
        description="Execute comprehensive internal stakeholder communication plan for employees, partners, and investors.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=6.0,
        estimated_cost=1200.0,
        dependency_task_ids=[immediate_response_strategy.task_id],
    ...
    media_relations_management = Task(
        ...
        description="Manage ongoing media relations and control narrative with spokesperson coordination and monitoring.",
        status=TaskStatus.PENDING,
    ...
    customer_engagement_program = Task(
        ...
        description="Implement direct customer engagement and retention programs with compensation and service enhancement.",
        status=TaskStatus.PENDING,
    ...
    legal_regulatory_coordination = Task(
        ...
        description="Coordinate legal and regulatory compliance requirements with risk assessment and documentation.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=12.0,
        estimated_cost=2400.0,
        dependency_task_ids=[crisis_assessment.task_id],
    ...
    digital_reputation_recovery = Task(
        ...
        description="Implement comprehensive digital reputation recovery with SEO, content creation, and online review management.",
        status=TaskStatus.PENDING,
    ...
    brand_trust_rebuilding = Task(
        ...
        description="Execute long-term brand trust rebuilding with community engagement and trust metrics monitoring.",
        status=TaskStatus.PENDING,
    ...
    crisis_lessons_documentation = Task(
        ...
        description="Document crisis response lessons learned and update protocols for future crisis preparedness.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=8.0,
        estimated_cost=1600.0,
    ...
    sentiment_monitoring_dashboard = Task(
        ...
        description="Create real-time sentiment monitoring dashboard across all platforms with automated alerts.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=6.0,
        estimated_cost=1200.0,
        dependency_task_ids=[crisis_assessment.task_id],
    ...
    crisis_communication_hub = Task(
        ...
        description="Set up centralized crisis communication hub for coordinated messaging and stakeholder updates.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=4.0,
        estimated_cost=800.0,
        dependency_task_ids=[executive_team_activation.task_id],
    ...
    stakeholder_feedback_integration = Task(
        ...
        description="Implement system for collecting and integrating stakeholder feedback into response strategy adjustments.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=6.0,
        estimated_cost=1200.0,
