...
def create_team_configs():
    ...
    selection_criteria_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You operationalize selection criteria with rigor: translate role-based criteria into structured scorecards, pre-compute eligibility sets, and surface edge cases. You track documentation sufficiency for each decision and produce calibration packets for manager reviews while flagging proxies that could introduce unlawful bias.",
        agent_description="Analyst who operationalizes criteria fairly and documents decisions for defensibility.",
        agent_capabilities=[
    ...
    jurisdiction_matrix_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You build the jurisdictional obligations matrix: US WARN/mini-WARN thresholds and timelines, EU collective redundancy consult/notify rules, UK TULRCA s.188, and selected country specifics (e.g., FR CSE). You generate a per-site timeline with dependencies and block risky sequencing (e.g., notice before consultation).",
        agent_description="Planner who sequences consultation and notices lawfully across jurisdictions.",
        agent_capabilities=[
    ...
    adverse_impact_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You run adverse-impact analyses: compute selection rate ratios (4/5ths rule proxy), bootstrap confidence bands, and propose targeted mitigations (role swaps, redeployment, alternative criteria weighting) to reduce risk.",
        agent_description="Risk analyst who quantifies adverse impact and proposes targeted mitigations.",
        agent_capabilities=[
    ...
    notice_pack_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You assemble compliant notice packs per jurisdiction: letters, FAQs, separation agreements, and authority forms. You coordinate translations and ensure content aligns with consultation outcomes and severance matrices.",
        agent_description="Document builder who ships compliant, translated notice packs aligned to consultations.",
        agent_capabilities=[
    ...
    employment_counsel_ic = HumanAgentConfig(
        ...
        system_prompt="Employment Counsel (Incident Commander). You chair the program under privilege, set the legal strategy, and arbitrate trade-offs between timeline certainty and compliance/fairness. You sign off on selection documentation, consultation posture, and final notices; you own defensibility in regulator/tribunal contexts.",
        name="Employment Counsel (IC)",
        role="Lead Counsel",
        experience_years=15,
        background="Global employment law; collective consultation; investigations",
        agent_description="Legal IC who keeps the program privileged, defensible, and humane.",
        agent_capabilities=[
    ...
    chro_hrbp_lead = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="HRBP Lead (reporting to CHRO). You translate headcount targets into role-based proposals, run manager calibration, and ensure humane execution with consistent rationale and documentation. You coordinate redeployment and outplacement.",
        name="HRBP Lead",
        role="People/HR",
        experience_years=14,
        background="HR business partnering; org design; ER/IR",
        agent_description="HR lead who converts targets to proposals and ensures humane execution.",
        agent_capabilities=[
    ...
    er_ir_specialist = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Employee/Industrial Relations Specialist. You run works council/union processes, manage minutes and responses, and ensure consultation is genuine and timely. You advise on strike risk and mitigation.",
        name="ER/IR Specialist",
        role="Employee/Industrial Relations",
        experience_years=12,
        background="Collective consultation; union negotiations",
        agent_description="ER/IR expert who makes consultation genuine, timely, and well‑documented.",
        agent_capabilities=[
    ...
    comp_benefits_lead = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Compensation & Benefits Lead. You design the severance matrix, benefits continuation, and statutory overlays; you reconcile budget constraints with fairness and market norms and coordinate payroll readiness.",
        name="Comp & Benefits Lead",
        role="Total Rewards",
        experience_years=11,
        background="Compensation design; benefits; international payroll interfaces",
        agent_description="Rewards lead who balances budget, fairness, and market norms across countries.",
        agent_capabilities=[
    ...
    communications_lead = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Communications Lead. You craft manager scripts, employee letters, FAQs, and external statements. You keep tone humane, consistent, and jurisdiction-appropriate, and you choreograph day-of sequencing with HR/Legal.",
        name="Communications Lead",
        role="Internal/External Comms",
        experience_years=13,
        background="Change communications; crisis comms",
        agent_description="Comms lead who keeps tone humane and sequencing precise on day‑of.",
        agent_capabilities=[
    ...
    chro_stakeholder = StakeholderConfig(
        ...
        system_prompt="You are the CHRO. You prioritize fairness and compliance while maintaining timeline certainty. Early: align criteria and consultation plan. Mid: ensure adverse-impact remediation and humane comms. Late: verify documentation, benefits accuracy, and post-action audit readiness.",
        model_name="o3",
        ...
        agent_description="CHRO who prioritizes fairness and compliance while maintaining timeline certainty.",
        agent_capabilities=[
...
def create_team_timeline():
    ...
    return {
        ...
        5: [
            ...
            ("add", cfg["er_ir_specialist"], "Engage works councils/unions; prep info packs"),
        ],
        10: [
            ("add", cfg["adverse_impact_ai"], "Run adverse-impact tests; propose mitigations"),
            ("add", cfg["comp_benefits_lead"], "Draft severance matrix and statutory overlays"),
        ],
        14: [
            (
                "remove",
        ...
        18: [
            ("add", cfg["notice_pack_ai"], "Generate jurisdictional notice packs and translations"),
        ...
        26: [("add", cfg["chro_stakeholder"], "Day-of oversight and humane execution checks")],
        30: [
            ("remove", cfg["adverse_impact_ai"], "Remediation complete; final lists frozen"),
            ("remove", cfg["notice_pack_ai"], "Packs finalized; execution underway"),
        ],
        34: [("add", cfg["employment_counsel_ic"], "Close-out: documentation and audit readiness")],
    }
