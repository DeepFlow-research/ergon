...
def create_workflow() -> Workflow:
    ...
    financial_foundation = Task(
        ...
        description="Establish PCAOB audit relationship, implement baseline financial controls, and prepare audited financial statements for S-1 registration.",
    ...
    governance_setup = Task(
        ...
        description="Establish independent board structure, audit and compensation committees, and governance policies meeting NYSE/Nasdaq listing standards.",
        status=TaskStatus.PENDING,
    ...
    s1_preparation = Task(
        ...
        description="Draft comprehensive S-1 registration statement with business narrative, risk factors, MD&A, and regulatory disclosures.",
        status=TaskStatus.PENDING,
    ...
    sox_implementation = Task(
        ...
        description="Implement SOX 302 disclosure controls, establish ICFR framework, and prepare management certification processes.",
        status=TaskStatus.PENDING,
    ...
    legal_compliance = Task(
        ...
        description="Obtain required legal opinions, prepare EDGAR submissions, and ensure securities law compliance.",
        status=TaskStatus.PENDING,
    ...
    exchange_preparation = Task(
        ...
        description="Verify listing standard compliance, conduct market value analysis, and prepare exchange application.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=35.0,
        estimated_cost=5250.0,
    ...
    marketing_strategy = Task(
        ...
        description="Develop quiet period compliance strategy and investor relations framework.",
        status=TaskStatus.PENDING,
    ...
    due_diligence = Task(
        ...
        description="Complete underwriter due diligence preparation and final SEC submission readiness.",
        status=TaskStatus.PENDING,
    ...
    submission_coordination = Task(
        ...
        description="Coordinate SEC submission, manage comment letter process, and prepare for effective date.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=25.0,
        estimated_cost=3750.0,
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                description="All financial statement audits must be performed by PCAOB-registered auditors.",
            ...
            Constraint(
                ...
                description="Board must have majority independent directors meeting NYSE/Nasdaq standards.",
                constraint_type="hard",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="SOX 302 disclosure controls and management certifications must be implemented.",
                constraint_type="hard",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="All material information must be disclosed in S-1 with supporting documentation.",
                constraint_type="regulatory",
                enforcement_level=0.95,
                applicable_task_types=["Risk Factors Documentation", "S-1 Registration Statement"],
                metadata={},
            ),
            Constraint(
                name="Quiet Period Compliance",
                description="All communications must comply with quiet period restrictions and gun-jumping rules.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="All EDGAR submissions must pass validation tests without error codes.",
                constraint_type="regulatory",
                enforcement_level=0.9,
            ...
            Constraint(
                ...
                description="Comfort letters must be available for underwriter due diligence requirements.",
            ...
            Constraint(
                ...
                description="Company must meet all quantitative and qualitative listing requirements.",
                constraint_type="regulatory",
                enforcement_level=0.9,
            ...
            Constraint(
                ...
                description="ICFR documentation must be comprehensive and support management assessments.",
                constraint_type="organizational",
