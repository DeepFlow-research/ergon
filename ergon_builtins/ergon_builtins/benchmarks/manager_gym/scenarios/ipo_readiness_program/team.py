...
def create_team_configs():
    ...
    financial_controller = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Financial Controller focusing on PCAOB audit coordination, financial statement preparation, and non-GAAP reconciliation compliance for SEC registration.",
        agent_description="Controller who orchestrates audit‑ready financials and keeps the S‑1 numbers clean and defensible.",
        agent_capabilities=[
    ...
    securities_lawyer = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Securities Lawyer specializing in S-1 registration statement drafting, SEC disclosure requirements, and quiet period compliance.",
        agent_description="Securities specialist who steers S‑1 drafting and keeps the team aligned with SEC rules and timelines.",
        agent_capabilities=[
    ...
    governance_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Corporate Governance Specialist establishing board independence, committee structures, and NYSE/Nasdaq listing compliance.",
        agent_description="Governance architect who sets board independence, committees, and listing compliance mechanics.",
        agent_capabilities=[
    ...
    sox_compliance_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You design and implement SOX 302/404 internal controls, disclosure controls & procedures, and management certification processes for public company readiness.",
        agent_description="Controls leader who operationalizes SOX 302/404 and ensures certifiable management assertions.",
        agent_capabilities=[
    ...
    audit_coordinator = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You coordinate PCAOB audits, manage comfort letter processes, and ensure audit opinion quality for IPO registration.",
        agent_description="Coordination hub for auditors, comfort letters, and opinion deliverables on IPO timeline.",
        agent_capabilities=[
    ...
    edgar_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You prepare EDGAR submissions, manage SEC filing workflows, and coordinate regulatory submission timing and validation.",
        agent_description="EDGAR operator who gets filings right the first time and keeps submissions on schedule.",
        agent_capabilities=[
    ...
    disclosure_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You analyze materiality thresholds, draft risk factor disclosures, and ensure comprehensive MD&A narrative preparation.",
        agent_description="Analyst who drives materiality analysis and clear MD&A and risk narratives.",
        agent_capabilities=[
    ...
    ir_communications = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You develop investor relations strategy, manage quiet period protocols, and coordinate marketing communications compliance with Regulation FD.",
        agent_description="IR lead who choreographs quiet‑period comms and prepares the market narrative with compliance.",
        agent_capabilities=[
    ...
    external_auditor = HumanAgentConfig(
        ...
        agent_description="External audit partner who signs opinions and ensures audit evidence supports investor‑grade disclosures.",
        agent_capabilities=[
    ...
    sec_counsel = HumanAgentConfig(
        ...
        agent_description="SEC counsel who guides interactions with the Staff and keeps the S‑1 process smooth and compliant.",
        agent_capabilities=[
    ...
    independent_director = HumanAgentConfig(
        ...
        agent_description="Board leader who ensures governance readiness and credible oversight structures for life as a public company.",
        agent_capabilities=[
    ...
    audit_committee_chair = HumanAgentConfig(
        ...
        agent_description="Financial expert who validates internal controls and auditor independence before sign‑off.",
        agent_capabilities=[
    ...
    underwriter_counsel = HumanAgentConfig(
        ...
        agent_description="Underwriters’ counsel who runs due‑diligence rigor and coordinates comfort mechanics with banks.",
        agent_capabilities=[
    ...
    listing_specialist = HumanAgentConfig(
        ...
        agent_description="Exchange liaison who ensures quantitative/qualitative listing boxes are genuinely ticked.",
        agent_capabilities=[
    ...
    internal_audit_director = HumanAgentConfig(
        ...
        agent_description="Internal audit lead who validates process control maturity and audit trail completeness.",
        agent_capabilities=[
    ...
    cfo_approval = HumanAgentConfig(
        ...
        agent_description="CFO who certifies the numbers and ensures investor‑grade readiness across finance and controls.",
        agent_capabilities=[
    ...
    stakeholder = StakeholderConfig(
        ...
        system_prompt="You are the company CEO balancing IPO timing, market conditions, regulatory compliance, and disclosure transparency.",
        model_name="o3",
        name="Company CEO",
        role="Executive Stakeholder",
        persona_description="Strategic, market-focused, values timing and transparency balance for successful public offering.",
        agent_description="CEO decision‑maker who integrates market timing with compliance and disclosure quality for IPO success.",
        agent_capabilities=[
...
def create_team_timeline():
    ...
    return {
        ...
        28: [
            ...
            ("add", cfg["exchange_listing_specialist"], "Listing standards verification"),
        ],
        30: [
