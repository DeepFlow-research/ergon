...
from ergon_builtins.benchmarks.manager_gym.source_types import AIAgentConfig, HumanAgentConfig
...
def create_team_configs():
    ...
    crisis_coordinator = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Crisis Management Coordinator responsible for 24/7 crisis operations, emergency response coordination, and executive escalation protocols under extreme time pressure.",
        agent_description="Coordinator who stands up 24/7 crisis ops, enforces escalation, and keeps decision logs crisp.",
        agent_capabilities=[
    ...
    safety_engineer = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Product Safety Engineer conducting immediate safety assessments, defect characterization, risk analysis, and technical failure investigation for automotive components.",
        agent_description="Engineer who quickly characterizes defects and quantifies safety risk to drive decisions.",
        agent_capabilities=[
    ...
    quality_assurance_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Quality Assurance Specialist implementing root cause analysis, design modifications, enhanced testing protocols, and supplier quality improvements.",
        agent_description="QA specialist who leads root cause and hardens quality with better tests and supplier oversight.",
        agent_capabilities=[
    ...
    regulatory_affairs_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Regulatory Affairs Manager coordinating multi-jurisdiction regulatory filings across NHTSA, Transport Canada, EU GPSR, and 15 national authorities with synchronized timelines.",
        agent_description="Regulatory lead who synchronizes filings across authorities and keeps timings aligned.",
        agent_capabilities=[
    ...
    compliance_coordinator = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Compliance Coordinator managing recall effectiveness monitoring, consumer response tracking, and regulatory status reporting across all markets targeting >95% completion rates.",
        agent_description="Coordinator who drives completion rates and keeps regulators and consumers informed.",
        agent_capabilities=[
    ...
    communications_director = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Communications Director managing crisis communication strategy, consumer safety notifications, media relations, and multi-channel stakeholder communication across global markets.",
        agent_description="Communications lead who manages multi‑channel messages that are accurate and reassuring.",
        agent_capabilities=[
    ...
    customer_service_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Customer Service Manager deploying 24/7 customer hotlines, online portals, and customer return processing systems for global recall operations.",
        agent_description="Service leader who scales inbound channels and smoothes returns at peak load.",
        agent_capabilities=[
    ...
    logistics_coordinator = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Logistics Coordinator managing global reverse supply chain operations, dealer network coordination, and product retrieval across 15 countries.",
        agent_description="Logistics planner who orchestrates global reverse supply chains under pressure.",
        agent_capabilities=[
    ...
    supply_chain_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Supply Chain Manager implementing inventory quarantine, disposal protocols, and supplier coordination while maintaining partner relationships.",
        agent_description="Supply chain lead who quarantines inventory and keeps partners aligned and safe.",
        agent_capabilities=[
    ...
    legal_counsel = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are Legal Counsel managing multi-jurisdiction liability, litigation strategy development, and legal risk mitigation across 15 countries for product recall operations.",
        agent_description="Counsel who manages liability and litigation risk while enabling decisive action.",
        agent_capabilities=[
    ...
    financial_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Financial Analyst managing crisis budget parameters, insurance claims processing, and financial impact containment for global recall operations.",
        agent_description="Analyst who contains financial impact and optimizes insurance recovery.",
        agent_capabilities=[
    ...
    brand_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Brand Manager developing customer confidence rebuilding campaigns, competitive repositioning strategy, and brand reputation recovery targeting >80% confidence restoration.",
        agent_description="Brand leader who rebuilds trust with credible actions and clear messaging.",
        agent_capabilities=[
    ...
    market_reentry_strategist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Market Re-entry Strategist coordinating product redesign validation, regulatory approvals for sales resumption, and enhanced quality assurance protocols.",
        agent_description="Strategist who choreographs the path back to market with validated fixes.",
        agent_capabilities=[
    ...
    nhtsa_examiner = HumanAgentConfig(
        ...
        agent_description="US regulator who reviews defect reports and validates recall effectiveness.",
        agent_capabilities=[
    ...
    transport_canada_official = HumanAgentConfig(
        ...
        agent_description="Canadian regulator who coordinates approval and monitoring.",
        agent_capabilities=[
    ...
    eu_gpsr_coordinator = HumanAgentConfig(
        ...
        agent_description="EU coordinator who ensures GPSR compliance and oversight across member states.",
        agent_capabilities=[
    ...
    ceo = HumanAgentConfig(
        ...
        agent_description="Chief executive who sets priorities, communicates externally, and owns final decisions.",
        agent_capabilities=[
    ...
    chief_safety_officer = HumanAgentConfig(
        ...
        agent_description="Safety leader who keeps consumer protection paramount and protocols enforced.",
        agent_capabilities=[
    ...
    general_counsel = HumanAgentConfig(
        ...
        agent_description="General Counsel who approves legal strategy and manages liability exposure.",
        agent_capabilities=[
    ...
    chief_financial_officer = HumanAgentConfig(
        ...
        agent_description="CFO who approves crisis budget and steers financial impact containment.",
        agent_capabilities=[
    ...
    independent_safety_auditor = HumanAgentConfig(
        ...
        agent_description="Independent validator who pressure‑tests recall effectiveness.",
        agent_capabilities=[
    ...
    insurance_adjuster = HumanAgentConfig(
        ...
        agent_description="Adjuster who expedites valid claims and optimizes coverage use.",
        agent_capabilities=[
            "Processes claims",
    ...
    consumer_advocacy_representative = HumanAgentConfig(
        ...
        agent_description="Advocate who ensures consumer protections are real and visible.",
        agent_capabilities=[
    ...
    board_chair = HumanAgentConfig(
        ...
        agent_description="Board leader who provides governance oversight and final approvals.",
        agent_capabilities=[
...
def create_team_timeline():
    ...
    return {
        0: [
            ...
            ("add", cfg["regulatory_affairs_manager"], "Emergency regulatory notifications"),
        ...
        5: [
            ...
            ("add", cfg["transport_canada_official"], "Canadian regulatory coordination"),
        ...
        20: [
            ...
            ("add", cfg["consumer_advocacy_representative"], "Consumer protection oversight"),
        ],
        30: [
            ("add", cfg["brand_manager"], "Brand recovery strategy"),
            ("add", cfg["market_reentry_strategist"], "Market re-entry planning"),
        ],
        40: [("add", cfg["board_chair"], "Board governance and final approvals")],
    }
