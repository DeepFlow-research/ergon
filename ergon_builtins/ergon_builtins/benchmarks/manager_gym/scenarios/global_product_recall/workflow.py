...
def create_workflow() -> Workflow:
    ...
    crisis_assessment = Task(
        ...
        description="Conduct immediate safety assessment, determine recall scope, activate crisis management team, and establish incident command structure with regulatory consultation.",
    ...
    regulatory_notifications = Task(
        ...
        description="Prepare and submit comprehensive regulatory notifications to NHTSA, Transport Canada, EU GPSR, and all 15 national authorities with coordinated timeline.",
        status=TaskStatus.PENDING,
    ...
    consumer_communication = Task(
        ...
        description="Deploy multi-channel consumer safety notifications, activate customer service infrastructure, and implement crisis communication strategy across all markets.",
        status=TaskStatus.PENDING,
    ...
    crisis_management_coordination = Task(
        ...
        description="Establish crisis management governance, executive communication protocols, and decision-making authority with audit trail documentation.",
        status=TaskStatus.PENDING,
    ...
    product_retrieval_logistics = Task(
        ...
        description="Activate reverse supply chain operations, coordinate dealer networks, and manage customer return processing across all 15 markets.",
        status=TaskStatus.PENDING,
    ...
    inventory_management = Task(
        ...
        description="Identify and quarantine all affected inventory, implement disposal protocols, and manage supply chain partner coordination.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=32.0,
        estimated_cost=100000.0,
    ...
    root_cause_analysis = Task(
        ...
        description="Conduct comprehensive technical failure investigation, develop design modifications, and implement enhanced testing protocols with validation evidence.",
        status=TaskStatus.PENDING,
    ...
    supplier_quality_improvements = Task(
        ...
        description="Implement supplier quality improvements, manufacturing process corrections, and enhanced quality assurance with supplier agreement updates.",
        status=TaskStatus.PENDING,
    ...
    compliance_monitoring = Task(
        ...
        description="Implement recall effectiveness monitoring, consumer response tracking, and regulatory status reporting across all markets.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=40.0,
    ...
    legal_financial_coordination = Task(
        ...
        description="Manage liability across jurisdictions, process insurance claims, develop litigation strategy, and coordinate financial impact mitigation.",
        status=TaskStatus.PENDING,
    ...
    market_reentry_preparation = Task(
        ...
        description="Prepare comprehensive market re-entry strategy including product redesign validation, regulatory approvals, and enhanced quality protocols.",
        status=TaskStatus.PENDING,
    ...
    customer_confidence_recovery = Task(
        ...
        description="Implement comprehensive customer confidence rebuilding campaign and competitive repositioning strategy to restore brand reputation.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=48.0,
        estimated_cost=300000.0,
    ...
    program_management = Task(
        ...
        description="Provide overall crisis program management, timeline coordination, and cross-functional integration throughout the recall process.",
        status=TaskStatus.PENDING,
    ...
    stakeholder_communication = Task(
        ...
        description="Manage ongoing stakeholder communication including investors, suppliers, dealers, media, and regulatory authorities throughout the crisis.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=80.0,
        estimated_cost=200000.0,
        dependency_task_ids=[crisis_assessment.task_id],
    ...
    quality_assurance_oversight = Task(
        ...
        description="Provide independent quality assurance oversight and process validation throughout the recall and remediation process.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=60.0,
        estimated_cost=150000.0,
        dependency_task_ids=[regulatory_notifications.task_id],
    ...
    workflow.constraints.extend(
        [
            ...
            Constraint(
                ...
                applicable_task_types=["Regulatory Compliance Documentation & Monitoring"],
                metadata={},
            ),
            Constraint(
