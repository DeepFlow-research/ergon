...
def create_team_configs():
    ...
    academic_quality_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an Academic Quality Analyst specializing in OfS B-conditions compliance, external examiner report analysis, student outcome KPIs, and academic standards validation.",
        agent_description="Analyst who turns evidence into clear judgments about academic standards against OfS expectations.",
        agent_capabilities=[
    ...
    regulatory_compliance_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Regulatory Compliance Specialist focusing on OfS conditions mapping, consumer law compliance, UKVI sponsorship requirements, and Prevent duty documentation.",
        agent_description="Compliance mapper who aligns OfS/consumer/UKVI/Prevent requirements with auditable controls.",
        agent_capabilities=[
    ...
    data_quality_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Data Quality Manager responsible for HESA Data Futures validation, internal audit processes, data integrity controls, and GDPR compliance.",
        agent_description="Data steward who ensures HESA submissions are correct and the data trail stands up to audit.",
        agent_capabilities=[
    ...
    access_participation_coordinator = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You coordinate Access & Participation Plan updates, analyzing monitoring data, conducting gap analysis, and developing evidence-based intervention strategies.",
        agent_description="Coordinator who drives evidence‑based interventions and keeps APP reporting coherent.",
        agent_capabilities=[
    ...
    student_protection_officer = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Student Protection Officer ensuring CMA consumer law compliance, contract fairness, cost transparency, and student interest protection.",
        agent_description="Officer who safeguards student interests with fair contracts, clear costs, and credible protections.",
        agent_capabilities=[
    ...
    financial_sustainability_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You analyze institutional financial sustainability, conduct scenario planning, and maintain student protection plan documentation.",
        agent_description="Analyst who stress‑tests institutional finances and links risks to mitigation plans.",
        agent_capabilities=[
    ...
    governance_documentation_lead = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You assemble governance documentation, coordinate evidence packages, manage approval workflows, and ensure submission readiness.",
        agent_description="Documentation owner who assembles a coherent submission with traceable evidence.",
        agent_capabilities=[
    ...
    external_quality_reviewer = HumanAgentConfig(
        ...
        agent_description="Independent reviewer who validates standards and provides constructive external challenge.",
        agent_capabilities=[
    ...
    legal_compliance_counsel = HumanAgentConfig(
        ...
        agent_description="Counsel who ensures student‑facing obligations and consumer protections are truly met.",
        agent_capabilities=[
    ...
    data_protection_officer = HumanAgentConfig(
        ...
        agent_description="DPO who balances research/teaching needs with lawful processing and data minimization.",
        agent_capabilities=[
    ...
    internal_audit_director = HumanAgentConfig(
        ...
        agent_description="Assurance lead who validates process effectiveness and audit trail completeness.",
        agent_capabilities=[
    ...
    ukvi_compliance_manager = HumanAgentConfig(
        ...
        agent_description="UKVI lead who ensures sponsor licence compliance and robust status tracking.",
        agent_capabilities=[
    ...
    prevent_duty_coordinator = HumanAgentConfig(
        ...
        agent_description="Coordinator who ensures Prevent duties are met proportionately with clear safeguards.",
        agent_capabilities=[
    ...
    senate_chair = HumanAgentConfig(
        ...
        agent_description="Academic governance lead who challenges evidence and approves standards.",
        agent_capabilities=[
    ...
    university_council_chair = HumanAgentConfig(
        ...
        agent_description="Council chair who provides institutional oversight and final sign‑off.",
        agent_capabilities=[
    ...
    stakeholder = StakeholderConfig(
        ...
        system_prompt="You are the Vice-Chancellor balancing regulatory compliance, institutional reputation, and operational efficiency in the accreditation renewal process.",
        model_name="o3",
        ...
        agent_description="Vice‑Chancellor who sets direction, arbitrates trade‑offs, and signs off on a defensible submission.",
        agent_capabilities=[
...
def create_team_timeline():
    ...
    return {
        0: [
            ("add", cfg["academic_quality_analyst"], "Quality & standards evidence compilation"),
            (
                "add",
                cfg["regulatory_compliance_specialist"],
                "OfS conditions mapping and compliance",
            ),
            ("add", cfg["data_quality_manager"], "HESA data validation and quality controls"),
            ("add", cfg["governance_documentation_lead"], "Governance structure and documentation"),
        ],
        8: [
            ("add", cfg["access_participation_coordinator"], "Access & Participation Plan update"),
            (
                "add",
        ...
        12: [
            ("add", cfg["ukvi_compliance_manager"], "UKVI sponsor licence compliance validation"),
            ("add", cfg["prevent_duty_coordinator"], "Prevent duty compliance documentation"),
        ],
        16: [
            ("add", cfg["financial_sustainability_analyst"], "Financial sustainability assessment")
        ],
        20: [
        ...
        24: [
            ("add", cfg["data_protection_officer"], "Data protection and GDPR compliance review"),
            ("add", cfg["internal_audit_director"], "Internal audit and controls validation"),
        ],
        28: [("add", cfg["senate_chair"], "Academic governance approval")],
        30: [
            ("add", cfg["university_council_chair"], "Final institutional approval and submission")
        ],
    }
