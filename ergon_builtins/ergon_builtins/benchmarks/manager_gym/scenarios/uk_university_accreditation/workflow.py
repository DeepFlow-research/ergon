...
def create_workflow() -> Workflow:
    ...
    governance_setup = Task(
        ...
        description="Establish accreditation steering committee; define roles, responsibilities, and reporting lines; map OfS conditions to institutional accountability framework; set timeline and milestones.",
    ...
    quality_standards = Task(
        ...
        description="Compile evidence against OfS B-conditions (B1-B6); gather external examiner reports, student outcome KPIs, continuation/completion data, and remediation action plans.",
        status=TaskStatus.PENDING,
    ...
    consumer_law_audit = Task(
        ...
        description="Conduct comprehensive CMA compliance review of prospectus, contracts, and course information; ensure transparency of costs, contact hours, and student rights.",
        status=TaskStatus.PENDING,
    ...
    access_participation = Task(
        ...
        description="Update APP with latest monitoring data, gap analysis, and proposed interventions; align with OfS guidance and sector benchmarks for widening access.",
        status=TaskStatus.PENDING,
    ...
    ukvi_compliance = Task(
        ...
        description="Compile UKVI compliance evidence including attendance monitoring, CAS management, and reporting protocols to maintain sponsor licence status.",
        status=TaskStatus.PENDING,
    ...
    prevent_duty = Task(
        ...
        description="Compile Prevent duty evidence including risk assessment, training records, incident logs, and governing body oversight documentation.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=6.0,
        estimated_cost=900.0,
        dependency_task_ids=[governance_setup.id],
    ...
    data_quality = Task(
        ...
        description="Validate HESA Data Futures submissions; conduct internal audit of data integrity; compile signed statements and data validation evidence.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=10.0,
        estimated_cost=1500.0,
    ...
    financial_sustainability = Task(
        ...
        description="Compile financial sustainability evidence and student protection plan documentation to demonstrate ongoing viability and student interest protection.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=8.0,
        estimated_cost=1200.0,
    ...
    evidence_consolidation = Task(
        ...
        description="Consolidate all evidence packages; prepare comprehensive OfS submission documentation; obtain final governance approvals and submit to OfS.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=10.0,
        estimated_cost=1500.0,
        dependency_task_ids=[
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                description="All OfS ongoing conditions of registration (A-E) must be evidenced with comprehensive compliance documentation.",
            ...
            Constraint(
                ...
                description="UKVI sponsor licence compliance must be maintained with no major findings that could lead to licence suspension.",
                constraint_type="regulatory",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="All student data must be handled in compliance with GDPR and data quality standards validated through internal audit.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="All student-facing materials and contracts must comply with CMA consumer protection requirements.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="Prevent duty compliance must be evidenced with governing body oversight and training coverage ≥95%.",
                constraint_type="regulatory",
                enforcement_level=0.95,
            ...
            Constraint(
                ...
                description="Academic quality must meet sector benchmarks with external examiner validation and enhancement plans for underperformance.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="APP must be credible and evidence-based with demonstrable governance oversight and realistic targets.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="Financial sustainability must be evidenced with scenario planning and student protection arrangements.",
            ...
            Constraint(
                ...
                description="All key decisions must be documented with appropriate governance approval and sign-offs.",
                constraint_type="organizational",
                enforcement_level=0.9,
