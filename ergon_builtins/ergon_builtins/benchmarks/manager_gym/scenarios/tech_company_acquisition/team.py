...
def create_tech_acquisition_team_configs():
    ...
    tech_due_diligence_lead = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Technology Due Diligence Lead specializing in software architecture assessment, code quality analysis, cybersecurity audits, infrastructure scalability evaluation, and technical debt quantification with integration complexity mapping.",
        agent_description="Technical diligence lead who turns sprawling systems into a clear risk map and integration plan.",
        agent_capabilities=[
    ...
    business_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Business Analyst focusing on SaaS metrics validation (ARR, churn, CAC, LTV), customer contract analysis, recurring revenue sustainability, and operational workflow assessment.",
        agent_description="Business analyst who validates SaaS fundamentals and pressure‑tests growth assumptions.",
        agent_capabilities=[
    ...
    financial_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Financial Analyst conducting financial projection verification, competitive positioning evaluation, market opportunity sizing, and acquisition valuation analysis.",
        agent_description="Financial analyst who connects market reality to projections and valuation.",
        agent_capabilities=[
    ...
    systems_integration_architect = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Systems Integration Architect designing platform compatibility roadmaps, data migration planning, API integration design, and security infrastructure harmonization.",
        agent_description="Architect who designs pragmatic integration roadmaps and reduces migration risk.",
        agent_capabilities=[
    ...
    cybersecurity_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Cybersecurity Specialist conducting security audits, data privacy compliance verification, infrastructure security assessment, and integration security protocol design.",
        agent_description="Security specialist who finds material risks early and proposes workable mitigations.",
        agent_capabilities=[
    ...
    hr_integration_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an HR Integration Manager developing talent retention strategies, cultural assessment, organizational design, compensation harmonization, and employee communication initiatives.",
        agent_description="People leader who balances retention, culture, and org design through transition.",
        agent_capabilities=[
    ...
    customer_success_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Customer Success Manager ensuring customer relationship preservation, service continuity assurance, account management transition, and satisfaction monitoring.",
        agent_description="Customer steward who protects relationships and minimizes churn during the deal.",
        agent_capabilities=[
    ...
    project_coordination_lead = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Project Coordination Lead establishing integration management office, cross-functional team coordination, governance structures, and project tracking infrastructure.",
        agent_description="IMO lead who sets governance, coordinates teams, and drives decisions to closure.",
        agent_capabilities=[
    ...
    regulatory_counsel = HumanAgentConfig(
        ...
        agent_description="Antitrust strategist who sequences filings and navigates remedies with minimal deal friction.",
        agent_capabilities=[
    ...
    data_privacy_officer = HumanAgentConfig(
        ...
        agent_description="Privacy lead who ensures lawful data handling across both orgs throughout diligence and integration.",
        agent_capabilities=[
    ...
    ip_legal_specialist = HumanAgentConfig(
        ...
        agent_description="IP specialist who secures chain‑of‑title and practical licensing for the combined company.",
        agent_capabilities=[
    ...
    financial_controller = HumanAgentConfig(
        ...
        agent_description="Controller who keeps the numbers reliable across purchase accounting and integration.",
        agent_capabilities=[
    ...
    chief_technology_officer = HumanAgentConfig(
        ...
        agent_description="Technology leader who sets the integration vision and de‑risks technical transitions.",
        agent_capabilities=[
    ...
    executive_sponsor = HumanAgentConfig(
        ...
        agent_description="Executive owner who aligns stakeholders and clears organizational roadblocks.",
        agent_capabilities=[
    ...
    target_company_ceo = HumanAgentConfig(
        ...
        agent_description="Target leader who keeps talent engaged and customers supported during the transition.",
        agent_capabilities=[
    ...
    integration_steering_committee = HumanAgentConfig(
        ...
        agent_description="Governance body that enforces decision discipline and milestone accountability.",
        agent_capabilities=[
...
def create_tech_acquisition_team_timeline():
    ...
    return {
        0: [
            ...
            ("add", cfg["business_analyst"], "SaaS metrics and customer contract validation"),
            ("add", cfg["financial_analyst"], "Financial projection and valuation verification"),
            (
                "add",
                cfg["project_coordination_lead"],
                "Integration management office establishment",
            ),
            ("add", cfg["regulatory_counsel"], "Regulatory framework and compliance planning"),
        ],
        6: [
            (
                "add",
        ...
        12: [
            ...
            ("add", cfg["financial_controller"], "Financial integration and budget management"),
        ],
        18: [
            (
                "add",
        ...
        25: [
            ("add", cfg["executive_sponsor"], "Strategic oversight and stakeholder communication"),
            (
                "add",
