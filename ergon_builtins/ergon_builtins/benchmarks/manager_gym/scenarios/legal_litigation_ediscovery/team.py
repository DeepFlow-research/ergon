...
def create_litigation_team_configs():
    ediscovery_engineer = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an eDiscovery Engineer handling defensible collection, processing, and chain-of-custody.",
        agent_description="Engineer who makes the evidence pipeline defensible end‑to‑end and audit‑ready under FRCP.",
        agent_capabilities=[
    ...
    review_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Review Analyst conducting ECA, seed selection, TAR training, and QC sampling.",
        agent_description="Analyst who accelerates review with rigorous sampling, training, and quality control.",
        agent_capabilities=[
    ...
    production_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Production Specialist preparing Bates, load files, metadata, and redactions per protocol.",
        agent_description="Specialist who ships clean, protocol‑compliant productions that opposing can ingest without issue.",
        agent_capabilities=[
    ...
    supervising_attorney = HumanAgentConfig(
        ...
        agent_description="Lead attorney who ensures defensibility, privilege protection, and adherence to protocol.",
        agent_capabilities=[
    ...
    records_manager = HumanAgentConfig(
        ...
        agent_description="Custodian coordinator who makes legal holds stick and evidence preservation traceable.",
        agent_capabilities=[
    ...
    stakeholder = StakeholderConfig(
        ...
        agent_description="Decision owner who balances speed against defensibility and signs off on disclosure risk.",
        agent_capabilities=[
...
def create_litigation_team_timeline() -> dict[int, list]:
    ...
    return {
        ...
        6: [("add", cfg["review_analyst"], "ECA, seed sets, TAR & QC")],
        12: [("add", cfg["production_specialist"], "Prepare productions per protocol")],
        14: [("add", cfg["supervising_attorney"], "Approve protocols & privilege decisions")],
    }
