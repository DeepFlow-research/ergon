...
def create_workflow() -> Workflow:
    ...
    t1 = Task(
        ...
        description="Kickoff; define EV, consideration mix, must-have protections (RWI, escrow), risks, and cadence. Produce deal memo and seed risk register.",
    ...
    t2 = Task(
        ...
        description="Map approvals/decision rights; draft resolutions; confirm conflicts and engagements.",
        status=TaskStatus.PENDING,
    ...
    t3 = Task(
        ...
        description="Define diligence scope (legal/financial/tax/commercial/IP/privacy/HR/security), issue RFIs, and establish evidence standards with provenance.",
        status=TaskStatus.PENDING,
        dependency_task_ids=[t1.id],
    ...
    t4 = Task(
        ...
        description="Coordinate QoE and WC analysis; inform price, earnout metrics, and SPA drafting.",
        status=TaskStatus.PENDING,
    ...
    t5 = Task(
        ...
        description="Verify corporate standing, cap table, equity plans, disputes; summarize exposures.",
        status=TaskStatus.PENDING,
        dependency_task_ids=[t3.id],
    ...
    t6 = Task(
        ...
        description="Review key contracts (consents/MFN/termination), IP chain-of-title/OSS, and privacy posture.",
        status=TaskStatus.PENDING,
        dependency_task_ids=[t3.id],
    ...
    t7 = Task(
        ...
        description="Assess HSR reportability and CFIUS triggers; outline filing timeline and risk-sharing.",
        status=TaskStatus.PENDING,
    ...
    t8 = Task(
        ...
        description="Select structure (asset/stock/merger), elections, and rollover/earnout mechanics; draft step-plan.",
        status=TaskStatus.PENDING,
    ...
    t9 = Task(
        ...
        description="Secure debt commitments; coordinate RWI underwriting; align with SPA conditionality.",
        status=TaskStatus.PENDING,
    ...
    t10 = Task(
        ...
        description="Produce SPA v1 reflecting structure and diligence; seed disclosure schedules and consent lists.",
        status=TaskStatus.PENDING,
    ...
    t11 = Task(
        ...
        description="Iterative redlines with clear rationales and issue resolution; exec decision memos.",
        status=TaskStatus.PENDING,
    ...
    t12 = Task(
        ...
        description="Prepare/file HSR and any CFIUS notices; track requests and waiting periods.",
        status=TaskStatus.PENDING,
    ...
    t13 = Task(
        ...
        description="Build closing checklist; finalize consents and funds flow; bring-down reps/covenants.",
        status=TaskStatus.PENDING,
    ...
    t14 = Task(
        ...
        description="Execute signatures; confirm conditions precedent; release funds; circulate closing set.",
        status=TaskStatus.PENDING,
    ...
    t15 = Task(
        ...
        description="Track covenants (escrow/earnout/indemnities); ensure Day‑1 legal/commercial readiness.",
        status=TaskStatus.PENDING,
        dependency_task_ids=[t14.id],
        estimated_duration_hours=5.0,
        estimated_cost=1000.0,
    )
    for task in [t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15]:
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                applicable_task_types=["Authority & Governance Readiness", "Signing & Closing"],
                metadata={},
            ),
            Constraint(
                name="HSR Acceptance Before Close",
                description="HSR filing accepted and waiting period expired or early termination granted before closing.",
                constraint_type="hard",
                enforcement_level=1.0,
                applicable_task_types=["Regulatory Filings (HSR/CFIUS)", "Signing & Closing"],
                metadata={},
            ),
            Constraint(
                name="No Close Without Required Consents",
                description="All required third‑party consents listed on disclosure schedules must be obtained or waived.",
                constraint_type="hard",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="Debt/RWI and funds flow finalized; no unsatisfied financing‑out that jeopardizes closing.",
                constraint_type="hard",
                enforcement_level=1.0,
                applicable_task_types=["Financing Workstream (Debt/RWI)", "Signing & Closing"],
                metadata={},
            ),
            Constraint(
