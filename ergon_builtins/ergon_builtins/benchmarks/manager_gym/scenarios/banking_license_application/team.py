...
def create_banking_license_team_configs():
    ...
    regulatory_strategist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Regulatory Strategy Expert specializing in US banking regulations, OCC requirements, Federal Reserve coordination, and multi-jurisdiction regulatory navigation for foreign bank market entry.",
    ...
    legal_counsel = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are Legal Counsel focusing on banking law, regulatory compliance, corporate structure, and legal documentation for federal branch establishment and licensing.",
    ...
    compliance_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Compliance Specialist expert in AML/BSA programs, customer identification procedures, enhanced due diligence, and US banking compliance framework implementation.",
    ...
    risk_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Risk Management Specialist developing comprehensive risk frameworks including credit risk policies, market risk controls, operational risk assessment, and liquidity management.",
    ...
    capital_structuring_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Capital Structuring Analyst managing $50M minimum capital requirements, CED arrangements, funding strategy, and regulatory capital adequacy documentation.",
    ...
    financial_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Financial Analyst preparing business plans, financial projections, market analysis, and revenue forecasting for US market entry strategy.",
    ...
    operations_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an Operations Manager responsible for operational readiness including IT infrastructure, correspondent banking relationships, physical office setup, and service delivery capabilities.",
    ...
    technology_architect = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Technology Architect designing core banking systems, security infrastructure, regulatory reporting capabilities, and IT compliance framework implementation.",
    ...
    hr_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an HR Specialist managing staffing plans, senior management recruitment, background checks, training programs, and human resources policy development.",
    ...
    business_development_lead = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Business Development Lead developing US market entry strategy, competitive analysis, target customer segments, product offerings, and growth strategy implementation.",
    ...
    project_coordinator = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Project Coordinator managing overall project timeline, stakeholder coordination, milestone tracking, and ensuring regulatory approval process stays on 18-24 month timeline.",
    ...
    external_legal_advisor = HumanAgentConfig(
        ...
        agent_capabilities=["Specializes in US banking law and regulatory applications"],
    )
...
def create_banking_license_team_timeline():
    ...
    return {
        0: [
            ("add", cfg["regulatory_strategist"], "Regulatory strategy and feasibility assessment"),
            ("add", cfg["legal_counsel"], "Legal structure and documentation framework"),
            ("add", cfg["project_coordinator"], "Project management and coordination"),
            ("add", cfg["external_legal_advisor"], "Legal advisory and regulatory guidance"),
        ],
        5: [
            ("add", cfg["financial_analyst"], "Business plan and financial documentation"),
            ("add", cfg["compliance_specialist"], "Due diligence and background verification"),
        ...
        30: [
            ("add", cfg["internal_audit_director"], "Internal audit and controls review"),
            ("add", cfg["third_party_validator"], "Independent operational readiness validation"),
        ],
        35: [("add", cfg["board_chair"], "Board oversight and final approval")],
    }
