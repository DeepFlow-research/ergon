...
def create_team_configs() -> dict[str, AIAgentConfig | HumanAgentConfig]:
    inhouse_counsel = AIAgentConfig(
        ...
        agent_description="Pragmatic commercial counsel who drives redlines to closure while preserving principled risk posture and traceability.",
        agent_capabilities=[
    ...
    privacy_counsel = AIAgentConfig(
        ...
        agent_description="Privacy specialist who hardens DPAs and transfer mechanics and keeps obligations practical and compliant.",
        agent_capabilities=[
    ...
    security_risk = AIAgentConfig(
        ...
        agent_description="Security analyst who validates evidence, maps controls to standards, and proposes credible mitigations.",
        agent_capabilities=[
    ...
    procurement_lead = AIAgentConfig(
        ...
        agent_description="Commercial lead who aligns terms with policy and pairs concessions with risk‑balanced trade‑offs.",
        agent_capabilities=[
    ...
    finance_partner = AIAgentConfig(
        ...
        agent_description="Finance partner who builds clear models to quantify options and surface hidden costs early.",
        agent_capabilities=[
    ...
    business_owner = AIAgentConfig(
        ...
        agent_description="Accountable business owner who supplies practical constraints and makes timely calls to keep momentum.",
        agent_capabilities=[
    ...
    vendor_counsel = AIAgentConfig(
        ...
        agent_description="Constructive counterpart who proposes workable compromises and keeps paper consistent with reality.",
        agent_capabilities=[
    ...
    gc = HumanAgentConfig(
        ...
        agent_description="Senior legal approver who balances risk, business need, and precedent, and owns the final legal call.",
        agent_capabilities=[
    ...
    ciso = HumanAgentConfig(
        ...
        agent_description="Security approver who ensures commitments match capabilities and that risks are owned and time‑bound.",
        agent_capabilities=[
    ...
    dpo = HumanAgentConfig(
        ...
        agent_description="Privacy approver who keeps data use lawful and proportionate, and ensures subject rights are operable.",
        agent_capabilities=[
    ...
    cfo = HumanAgentConfig(
        ...
        agent_description="Finance approver who ensures the deal is economically sound and sustainable under realistic scenarios.",
        agent_capabilities=[
...
def create_team_timeline() -> dict[int, list]:
    ...
    return {
        ...
        5: [("add", cfg["finance_partner"], "Commercial modeling")],
        10: [("add", cfg["vendor_counsel"], "Begin negotiation rounds")],
        15: [
