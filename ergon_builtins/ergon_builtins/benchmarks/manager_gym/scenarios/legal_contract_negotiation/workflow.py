...
def create_workflow() -> Workflow:
    ...
    intake = Task(
        ...
        description="Collect use case, data flows, jurisdictions, contract templates, and stakeholder roster; define critical issues.",
    ...
    for t in [intake, drafting, reviews, negotiation, execution, playbook, dataroom]:
        wf.add_task(t)
    try:
