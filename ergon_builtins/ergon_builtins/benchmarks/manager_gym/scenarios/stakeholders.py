...
from ergon_builtins.benchmarks.manager_gym.source_types import PreferenceWeights
from ergon_builtins.benchmarks.manager_gym.source_types import StakeholderConfig


def _build_persona_config(persona: str, preferences: PreferenceWeights) -> StakeholderConfig:
    ...
    if persona_lower == "nitpicky":
        return StakeholderConfig(
            ...
            persona_description="Highly involved, interrupts often, requests clarifications and pushes suggestions.",
            ...
            agent_capabilities=["Approves tasks", "Requests clarifications", "Pushes suggestions"],
        )
    if persona_lower == "hands_off":
        return StakeholderConfig(
            ...
            persona_description="Very hands-off, rarely interrupts, minimal clarifications, relies on manager.",
    ...
    return StakeholderConfig(
        ...
        role="Business Owner",
        persona_description="Balanced involvement: occasional clarifications and suggestions; pragmatic and time-aware.",
...
def create_stakeholder_agent(persona: str, preferences: PreferenceWeights) -> StakeholderConfig:
