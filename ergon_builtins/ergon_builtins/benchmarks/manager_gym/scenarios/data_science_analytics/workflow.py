...
from ergon_builtins.benchmarks.manager_gym.scenarios.data_science_analytics.preferences import (
    create_preferences,
)
...
def create_workflow() -> Workflow:
    ...
    charter = Task(
        ...
        description="Define business objective, success metrics, assumptions, stakeholders, and risks.",
    ...
    access_governance = Task(
        ...
        description="Obtain data access approvals; review PII/PHI handling; document privacy controls.",
        status=TaskStatus.PENDING,
    ...
    env_setup = Task(
        ...
        description="Create project repo; pin dependencies; set seeds; enable experiment tracking; set up CI.",
        status=TaskStatus.PENDING,
    ...
    understanding = Task(
        ...
        description="Explore distributions, drift, missingness, outliers; identify leakage risks; create data summary.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=6.0,
    ...
    data_quality = Task(
        ...
        description="Implement checks (completeness, validity, uniqueness); remediate issues; create quality report.",
        status=TaskStatus.PENDING,
    ...
    model_eval = Task(
        ...
        description="Holdout evaluation; calibration; thresholding; error analysis; compare against acceptance targets.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=8.0,
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                description="PII/PHI must be handled per policy; sensitive fields redacted or access‑controlled in artifacts.",
            ...
            Constraint(
                ...
                description="Seeds and environment must be captured; experiments tracked; runs re‑executable end‑to‑end.",
            ...
            Constraint(
                ...
                description="A model card documenting data, metrics, risks, intended use, and limitations must be produced.",
                constraint_type="organizational",
            ...
            Constraint(
                ...
                description="Fairness metrics must meet policy thresholds or mitigations documented and signed off.",
                constraint_type="organizational",
                enforcement_level=0.9,
                applicable_task_types=["Responsible AI Checks", "Bias & Fairness Assessment"],
            ...
            Constraint(
                ...
                description="Monitoring and rollback strategy with owners must be defined prior to launch/pilot.",
                constraint_type="organizational",
                enforcement_level=0.9,
