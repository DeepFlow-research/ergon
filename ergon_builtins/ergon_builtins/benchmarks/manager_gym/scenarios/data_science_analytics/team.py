...
def create_team_configs():
    data_engineer = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Data Engineer focusing on ingestion pipelines, data quality checks, and lineage documentation. You are also responsible for the security of the data and the systems that process it.",
    ...
    data_scientist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Data Scientist specializing in feature engineering, baseline modeling, and experimentation.",
        agent_description="Data Scientist",
        agent_capabilities=["Feature engineering", "Baseline modeling", "Experimentation"],
    )
    mlops_engineer = AIAgentConfig(
        agent_id="mlops_engineer",
        agent_type="ai",
        system_prompt="You are an MLOps Engineer implementing reproducibility, CI/CD, packaging, and monitoring.",
    ...
    analytics_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an Analytics Analyst preparing KPI/ROI analysis and executive readouts.",
...
def create_team_timeline() -> dict[int, list]:
    ...
    return {
        ...
        10: [("add", cfg["mlops_engineer"], "Reproducibility & experiment tracking")],
        20: [("add", cfg["analytics_analyst"], "KPI analysis & readout drafting")],
        40: [("add", cfg["risk_officer"], "RAI review: fairness & explainability")],
        50: [("add", cfg["security_reviewer"], "Security review & deployment gate")],
    }
