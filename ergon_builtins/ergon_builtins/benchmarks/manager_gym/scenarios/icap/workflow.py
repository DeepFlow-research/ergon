...
def create_workflow() -> Workflow:
    ...
    governance_scope = Task(
        ...
        description="Define ICAAP scope and proportionality; update RAF/limits; map committees, decision rights, and escalation procedures; document ICAAP architecture.",
    ...
    risk_inventory = Task(
        ...
        description="Compile risk inventory (credit, market/CVA, IRRBB, operational, concentration, model risk). Assess materiality using gross approach; map methods and owners.",
        status=TaskStatus.PENDING,
    ...
    credit_risk = Task(
        ...
        description="Estimate PD/LGD/EAD, portfolio concentrations; compute economic capital with sensitivity analysis.",
        status=TaskStatus.PENDING,
    ...
    irrbb = Task(
        id=UUID(int=3),
        name="IRRBB (EVE/NII)",
        description="Measure EVE and NII under EBA standard shocks; justify behavioral assumptions; check limits.",
        status=TaskStatus.PENDING,
    ...
    op_risk = Task(
        ...
        description="Scenario-based OpRisk assessment with internal loss data; model risk overlay and parameter uncertainty.",
        status=TaskStatus.PENDING,
    ...
    stress_design = Task(
        ...
        description="Design baseline, adverse, and severe scenarios; calibrate macro and idiosyncratic drivers; define attributions.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=10.0,
        estimated_cost=1500.0,
    ...
    reverse_stress = Task(
        ...
        description="Define non-viability conditions and pathways; parameterize; link to remediation actions.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=8.0,
        estimated_cost=1200.0,
        dependency_task_ids=[],
    ...
    capital_planning = Task(
        ...
        description="Project earnings, RWAs, CET1 vs OCR+CBR; integrate P2R/P2G; MDA checks; size management buffer.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=12.0,
        estimated_cost=1800.0,
    ...
    mgmt_actions = Task(
        ...
        description="Define feasible, timely, quantified actions (issuance, dividend, RWA optimization) with triggers.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=8.0,
        estimated_cost=1200.0,
    ...
    board_pack = Task(
        ...
        description="Assemble CAS, risk coverage, stress results, capital plan, management actions; obtain approvals.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=6.0,
        estimated_cost=900.0,
    ...
    data_lineage = Task(
        ...
        description="Create registry of data sources, transformations, reconciliations; define control checks and owners.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=6.0,
        estimated_cost=900.0,
        dependency_task_ids=[],
    ...
    regulatory_mapping = Task(
        ...
        description="Map ICAAP sections to PRA/ECB/CRD/CRR and Basel principles; plan assurance scope with authorities.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=6.0,
        estimated_cost=900.0,
        dependency_task_ids=[],
    ...
    model_inventory = Task(
        ...
        description="Update model inventory entries; summarize backtesting/monitoring results and limitations.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=5.0,
        estimated_cost=750.0,
        dependency_task_ids=[],
    ...
    pii_controls = Task(
        ...
        description="Implement/redact PII/secret content; document access roles, approvals, and evidence of controls.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=4.0,
        estimated_cost=600.0,
        dependency_task_ids=[],
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                description="Independent validation artifacts must be produced and completed before submission.",
            ...
            Constraint(
                ...
                description="Board/C-level approvals and minutes must be assembled and finalized.",
                constraint_type="hard",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="A reverse stress test must be defined with clear non-viability conditions and linkages to actions.",
                constraint_type="hard",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="Confidential information must be redacted or access-controlled across artifacts and communications.",
                constraint_type="hard",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="ICAAP sections must be mapped to PRA/ECB/CRD/CRR and Basel principles with proportionality rationale.",
            ...
            Constraint(
                ...
                description="Data lineage registry, reconciliations, and control checks must be documented.",
            ...
            Constraint(
                ...
                description="Model inventory entries and backtesting/monitoring summaries must be updated.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="CET1 vs OCR+CBR with P2R/P2G must be assessed and MDA triggers/remedies evaluated.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="Material differences between economic and normative perspectives must be reconciled and documented.",
                constraint_type="organizational",
                enforcement_level=0.8,
                applicable_task_types=["Capital Planning"],
                metadata={},
