...
def create_team_configs():
    ...
    credit_modeler = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Credit Risk Modeler focusing on PD/LGD/EAD estimation, concentration risk, and economic capital computation with sensitivity analysis.",
        agent_description="Quant who produces defensible credit capital estimates with clear assumptions and sensitivity.",
        agent_capabilities=[
    ...
    irrbb_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an IRRBB Analyst specializing in EVE/NII measurement, behavioral assumptions, and policy limit checks under standard shocks.",
        agent_description="ALM analyst who quantifies EVE/NII risk under sound behavioral assumptions.",
        agent_capabilities=[
    ...
    op_risk_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an Operational Risk Analyst conducting scenario assessments with loss data and model risk overlays.",
        agent_description="Operational risk analyst who combines data and scenarios into credible loss estimates.",
        agent_capabilities=[
            "Analyzes loss data",
    ...
    stress_designer = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You design institution-wide stress scenarios (baseline/adverse/severe) and reverse stress tests, ensuring severity and plausibility with clear attribution.",
        agent_description="Designer who drafts plausible yet severe scenarios with clear attribution logic.",
        agent_capabilities=[
    ...
    capital_planner = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Capital Planning Analyst projecting earnings, RWAs, and CET1 vs OCR+CBR with P2R/P2G and MDA checks.",
        agent_description="Planner who projects capital trajectory vs OCR+buffers and turns results into actions.",
        agent_capabilities=[
    ...
    documentation_lead = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You assemble ICAAP documentation including CAS, risk coverage, stress results, and management actions with traceability.",
        agent_description="Editor who assembles a clear, traceable ICAAP pack with evidence links.",
        agent_capabilities=[
    ...
    model_validation = HumanAgentConfig(
        ...
        agent_description="Independent challenger who tests methods, data, and outcomes with rigor.",
        agent_capabilities=[
    ...
    compliance_officer = HumanAgentConfig(
        ...
        agent_description="Compliance lead who checks CRD/CRR alignment and SREP expectations.",
        agent_capabilities=[
    ...
    internal_audit = HumanAgentConfig(
        ...
        agent_description="Assurance function validating process control and documentation trail.",
        agent_capabilities=[
    ...
    board_committee = HumanAgentConfig(
        ...
        agent_description="Committee that provides challenge and approves the package prior to submission.",
        agent_capabilities=[
    ...
    stakeholder = StakeholderConfig(
        ...
        system_prompt="You are the bank CFO balancing regulatory compliance, delivery speed, and resource cost.",
        model_name="o3",
        name="Bank CFO",
        role="Executive Stakeholder",
        persona_description="Pragmatic, compliance-focused, values timely delivery with adequate quality.",
        agent_description="CFO who sets priorities, arbitrates trade‑offs, and signs off on ICAAP quality and timing.",
        agent_capabilities=[
...
def create_team_timeline():
    ...
    return {
        ...
        15: [("add", cfg["stress_designer"], "Scenario design")],
        40: [("add", cfg["capital_planner"], "Normative projections and buffers")],
        70: [
