...
def create_workflow() -> Workflow:
    ...
    regulatory_dossier = Task(
        ...
        description="Compile comprehensive eCTD dossier covering quality, safety, nonclinical, and clinical modules aligned with ICH guidelines for FDA/EMA submission.",
    ...
    manufacturing_validation = Task(
        ...
        description="Execute cGMP validation including process qualification, equipment validation (IQ/OQ/PQ), and demonstrate manufacturing readiness for commercial production.",
        status=TaskStatus.PENDING,
    ...
    qbd_framework = Task(
        ...
        description="Establish QbD framework with critical quality attributes (CQAs), critical process parameters (CPPs), and control strategy for lifecycle management.",
        status=TaskStatus.PENDING,
    ...
    pharmacovigilance = Task(
        ...
        description="Establish pharmacovigilance system with safety management plan, adverse event reporting, and signal detection protocols for post-market surveillance.",
        status=TaskStatus.PENDING,
    ...
    supply_chain = Task(
        ...
        description="Validate distribution network with serialization compliance, cold-chain controls, and logistics partner qualification for global launch.",
        status=TaskStatus.PENDING,
    ...
    market_access = Task(
        ...
        description="Develop market access strategy with payer dossiers, HTA submissions, and pricing strategy for successful commercial launch.",
        status=TaskStatus.PENDING,
    ...
    regulatory_submission = Task(
        ...
        description="Submit regulatory applications to FDA/EMA and manage review process including responses to regulatory questions and inspections.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=50.0,
        estimated_cost=7500.0,
    ...
    prelaunch_readiness = Task(
        ...
        description="Execute final launch readiness activities including commercial team training, inventory staging, and launch governance approvals.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=70.0,
        estimated_cost=10500.0,
    ...
    launch_authorization = Task(
        ...
        description="Secure final governance approvals from executive committee and regulatory authorities for commercial product release.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=30.0,
        estimated_cost=4500.0,
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                description="All manufacturing activities must comply with current Good Manufacturing Practice regulations.",
            ...
            Constraint(
                ...
                description="Regulatory dossier must comply with ICH guidelines Q8-Q11 and M4 formatting requirements.",
                constraint_type="hard",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="Patient safety considerations must take precedence over commercial timeline pressures.",
                constraint_type="hard",
                enforcement_level=1.0,
                applicable_task_types=["Pharmacovigilance System Setup", "Risk Management Plan"],
                metadata={},
            ),
            Constraint(
                name="Quality by Design Implementation",
                description="QbD principles must be implemented with documented CQAs, CPPs, and control strategy.",
            ...
            Constraint(
                ...
                description="Supply chain must implement serialization and track-and-trace per regulatory requirements.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="Temperature-sensitive products must maintain cold-chain integrity throughout distribution.",
                constraint_type="regulatory",
                enforcement_level=0.9,
            ...
            Constraint(
                ...
                description="Manufacturing facilities must be inspection-ready with complete documentation.",
            ...
            Constraint(
                ...
                description="Market access materials must include robust clinical and economic evidence packages.",
                constraint_type="organizational",
            ...
            Constraint(
                ...
                description="Major decisions must involve cross-functional input from regulatory, quality, safety, and commercial teams.",
                constraint_type="organizational",
                enforcement_level=0.85,
                applicable_task_types=[
