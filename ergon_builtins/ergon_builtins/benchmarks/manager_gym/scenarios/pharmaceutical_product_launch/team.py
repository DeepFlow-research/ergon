...
def create_team_configs():
    ...
    regulatory_affairs_lead = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Regulatory Affairs Lead focusing on eCTD dossier preparation, FDA/EMA submissions, and ICH guideline compliance for pharmaceutical product registration.",
        agent_description="Regulatory lead who charts a submission path and turns complex ICH/FDA/EMA rules into clear, auditable work.",
        agent_capabilities=[
    ...
    manufacturing_scientist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Manufacturing Scientist specializing in cGMP compliance, process validation, equipment qualification (IQ/OQ/PQ), and manufacturing scale-up for commercial production.",
        agent_description="Process scientist who scales reliably from lab to plant and proves cGMP compliance.",
        agent_capabilities=[
    ...
    quality_assurance_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Quality Assurance Manager implementing Quality by Design (QbD), critical quality attributes (CQAs), control strategies, and analytical method validation per ICH guidelines.",
        agent_description="QA leader who locks in QbD, CQAs, and control strategies that stand up to inspection.",
        agent_capabilities=[
    ...
    pharmacovigilance_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You design pharmacovigilance systems with risk management plans, adverse event reporting, signal detection protocols, and post-market safety surveillance for patient protection.",
        agent_description="PV specialist who designs systems that spot safety signals early and respond responsibly.",
        agent_capabilities=[
    ...
    market_access_strategist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Market Access Strategist developing HTA submissions, payer value dossiers, pricing strategies, and early access programs for successful commercial launch.",
        agent_description="Value storyteller who turns evidence into payer acceptance and ethical access pathways.",
        agent_capabilities=[
    ...
    supply_chain_coordinator = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You coordinate pharmaceutical supply chain operations including serialization, cold-chain validation, distribution partner qualification, and global logistics for product launch.",
        agent_description="Coordinator who keeps serialization, cold‑chain, and partners synchronized for launch.",
        agent_capabilities=[
    ...
    clinical_data_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You manage clinical data compilation for regulatory submissions including integrated safety/efficacy summaries, clinical study reports, and benefit-risk assessments for Module 5 of eCTD dossiers.",
        agent_description="Data manager who assembles clean, consistent clinical evidence suitable for Module 5.",
        agent_capabilities=[
    ...
    commercial_launch_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You coordinate commercial launch activities including sales team training, inventory staging, launch readiness reviews, and stakeholder engagement for successful market entry.",
        agent_description="Launch orchestrator who aligns training, inventory, and engagement to hit day‑1 readiness.",
        agent_capabilities=[
    ...
    fda_regulatory_consultant = HumanAgentConfig(
        ...
        agent_description="US regulatory advisor who anticipates questions and sharpens submission quality.",
        agent_capabilities=[
    ...
    ema_regulatory_consultant = HumanAgentConfig(
        ...
        agent_description="EU regulatory advisor who aligns CHMP expectations and shepherds submissions.",
        agent_capabilities=[
    ...
    quality_control_director = HumanAgentConfig(
        ...
        agent_description="QC leader who ensures methods, release, and quality systems are inspection‑ready.",
        agent_capabilities=[
    ...
    manufacturing_operations_head = HumanAgentConfig(
        ...
        agent_description="Manufacturing head who certifies plant readiness and compliant throughput.",
        agent_capabilities=[
    ...
    pharmacovigilance_director = HumanAgentConfig(
        ...
        agent_description="PV lead who assures patient protection and regulator confidence post‑launch.",
        agent_capabilities=[
    ...
    medical_affairs_director = HumanAgentConfig(
        ...
        agent_description="Medical leader who ensures scientific accuracy and ethical HCP engagement.",
        agent_capabilities=[
    ...
    regulatory_compliance_auditor = HumanAgentConfig(
        ...
        agent_description="Independent auditor who tests compliance and closes gaps before authorities do.",
        agent_capabilities=[
    ...
    commercial_executive = HumanAgentConfig(
        ...
        agent_description="Executive who aligns market strategy with safety/regulatory constraints to drive responsible success.",
        agent_capabilities=[
    ...
    launch_steering_committee = HumanAgentConfig(
        ...
        agent_description="Governance body that enforces gates and authorizes launch when evidence supports it.",
        agent_capabilities=[
    ...
    stakeholder = StakeholderConfig(
        ...
        system_prompt="You are the Chief Medical Officer balancing patient safety, regulatory compliance, commercial objectives, and launch timing.",
        model_name="o3",
        ...
        agent_description="CMO who prioritizes patient safety and compliance, and makes the final call on launch readiness.",
        agent_capabilities=[
...
def create_team_timeline():
    ...
    return {
        ...
        12: [
            ("add", cfg["pharmacovigilance_specialist"], "Pharmacovigilance system setup"),
        ...
        55: [("add", cfg["launch_steering_committee"], "Launch governance and authorization")],
    }
