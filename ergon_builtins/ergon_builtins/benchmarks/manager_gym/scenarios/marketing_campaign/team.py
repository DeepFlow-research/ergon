...
def create_team_configs():
    ...
    campaign_planner_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an AI Campaign Planner. Translate research and messaging into a channel plan and flighting calendar, maintain a living risk/dependency register, and propose weekly reallocations backed by performance signals.",
        agent_description="Planner who keeps the campaign coherent, evidence‑driven, and adaptable week to week.",
        agent_capabilities=[
    ...
    creative_director_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You generate creative territories, briefs, and variant matrices aligned to the messaging house; enforce brand voice and inclusive tone across assets.",
        agent_description="Creative partner who turns strategy into territories and briefs that scale across channels.",
        agent_capabilities=[
    ...
    copy_optimizer_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You produce channel-specific copy variants (search, social, display, email) and run hypothesis-driven A/B tests; ensure claims align with the substantiation playbook.",
        agent_description="Optimizer who ships clean variants and hardens copy through disciplined testing.",
        agent_capabilities=[
    ...
    seo_analyst_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You create the SEO roadmap: keyword clusters, pillar/topic pages, internal links, and structured data; deliver a content backlog tied to ICP pain points.",
        agent_description="SEO builder who aligns content to demand and makes the site discoverable and structured.",
        agent_capabilities=[
    ...
    media_buyer_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You manage paid search/social/display setup, budgets, frequency caps, audience definitions, and brand safety lists; run canary rollouts and scale winners.",
        agent_description="Buyer who paces budgets prudently, respects brand safety, and scales winners.",
        agent_capabilities=[
    ...
    analytics_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You define KPI specs, UTM governance, event schemas; build an executive dashboard and alerting; produce weekly readouts and experiment design checks.",
        agent_description="Analyst who puts measurement on rails and produces decision‑ready readouts.",
        agent_capabilities=[
    ...
    consent_compliance_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You enforce privacy-by-design for marketing: CMP setup, granular opt-ins, data minimization, and audit trails; monitor for green claims compliance coordination with Legal Marketing.",
        agent_description="Privacy guardian who keeps consent and minimization in place across all touchpoints.",
        agent_capabilities=[
    ...
    accessibility_checker_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You perform automated accessibility checks (contrast, alt text, captions) and flag copy for plain-language improvements; ensure WCAG 2.1 AA for web and key assets.",
        agent_description="Accessibility sentinel who reduces friction for users and keeps assets compliant.",
        agent_capabilities=[
    ...
    crm_ops_ai = AIAgentConfig(
        agent_id="crm_ops_ai",
        agent_type="ai",
        system_prompt="You configure lead scoring, routing, deduplication, and enrichment; track SLAs and feedback loops to Sales and Community Ops.",
        agent_description="Revops enabler who keeps the data clean and routes leads quickly and fairly.",
        agent_capabilities=[
    ...
    social_listener_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You monitor social/press signals, competitor moves, and sentiment; summarize insights for rapid creative and budget pivots.",
        agent_description="Signal scout who finds shifts in sentiment and competition early.",
        agent_capabilities=[
    ...
    cmo = HumanAgentConfig(
        ...
        system_prompt="Chief Marketing Officer: sets campaign objectives, approves budgets, and arbitrates trade-offs between speed, brand quality, and compliance.",
        name="Chief Marketing Officer",
        role="Executive Stakeholder",
        experience_years=18,
        background="Brand + growth leadership in energy/tech",
        agent_description="Executive who calibrates speed, brand quality, and compliance, and holds the team accountable.",
        agent_capabilities=[
    ...
    vp_marketing = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Owns cross-channel plan, staffing, and weekly readouts; accountable for pipeline and brand KPIs.",
        name="VP Marketing",
        role="LT Member",
        experience_years=14,
        background="Integrated marketing; B2B & B2C energy",
        agent_description="Operator who builds the team plan, cadence, and weekly readouts to drive pipeline and brand.",
        agent_capabilities=[
    ...
    brand_creative_director = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Leads creative territories, narrative, and asset QA; co-owns brand approvals with Legal Marketing.",
        name="Brand Creative Director",
        role="Creative Lead",
        experience_years=12,
        background="Brand systems; climate storytelling",
        agent_description="Creative leader who maintains brand integrity and approves high‑impact assets.",
        agent_capabilities=[
    ...
    performance_media_manager = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Owns paid budgets, platform ops, and pacing; enforces brand safety and flighting guardrails.",
        name="Performance Media Manager",
        role="Paid Media",
        experience_years=8,
        background="Paid search/social/display; MMM-aware ops",
        agent_description="Buyer/ops lead who keeps spend efficient and brand‑safe across platforms.",
        agent_capabilities=[
    ...
    web_lead = HumanAgentConfig(
        agent_id="web_lead",
        agent_type="human_mock",
        system_prompt="Owns LP builds, analytics implementation, CMP integration, and accessibility compliance.",
        name="Web Experience Lead",
        role="Web/Conversion",
        experience_years=9,
        background="CRO + analytics; accessibility",
        agent_description="Web owner who ships accessible, measurable experiences that convert.",
        agent_capabilities=[
    ...
    crm_lifecycle_manager = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Owns lifecycle design, deliverability, and preference center; collaborates with Sales/Community Ops.",
        name="CRM & Lifecycle Manager",
        role="Lifecycle/Email",
        experience_years=7,
        background="CRM, deliverability, consent ops",
        agent_description="Lifecycle owner who ensures deliverability and respectful, effective nurture.",
        agent_capabilities=[
    ...
    pr_lead = HumanAgentConfig(
        agent_id="pr_lead",
        agent_type="human_mock",
        system_prompt="Owns PR/analyst relations; develops press kit, handles briefings, and coverage tracking.",
        name="PR Lead",
        role="PR/AR",
        experience_years=10,
        background="Energy/tech PR and analyst relations",
        agent_description="PR lead who secures accurate coverage and prepares spokespeople.",
        agent_capabilities=[
    ...
    events_manager = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Owns event kits, webinar production, staffing, and logistics with lead-capture compliance.",
        name="Events & Field Manager",
        role="Events",
        experience_years=8,
        background="Industry events, webinars, field ops",
        agent_description="Producer who ships smooth events with compliant lead capture.",
        agent_capabilities=[
    ...
    partnerships_manager = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Leads co-marketing with installers/finance/local programs; coordinates MDF and partner approvals.",
        name="Partnerships Manager",
        role="Alliances/Partners",
        experience_years=9,
        background="Channel/alliances; co-marketing",
        agent_description="Alliances lead who amplifies reach via partners without compromising brand or compliance.",
        agent_capabilities=[
    ...
    data_analyst = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Builds dashboards, QA analytics, designs experiments, and assists MMM/MTA alignment.",
        name="Marketing Data Analyst",
        role="Analytics",
        experience_years=6,
        background="Attribution & experimentation",
        agent_description="Analyst who gets the right numbers to the right forums to drive decisions.",
        agent_capabilities=[
            "Builds dashboards",
    ...
    legal_marketing_counsel = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Advises on environmental claims substantiation and privacy; reviews partner co-branding and PR.",
        name="Legal Marketing Counsel",
        role="Legal (Marketing)",
        experience_years=11,
        background="Advertising/consumer protection; privacy",
        agent_description="Counsel who keeps claims truthful and privacy‑safe across assets and partners.",
        agent_capabilities=[
    ...
    accessibility_specialist = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Conducts manual WCAG 2.1 AA reviews and remediation guidance for key assets and flows.",
        name="Accessibility Specialist",
        role="Accessibility",
        experience_years=8,
        background="WCAG audits, inclusive design",
        agent_description="Expert who ensures AA compliance and reduces friction for users with disabilities.",
        agent_capabilities=[
    ...
    sustainability_officer = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Validates environmental metrics (RECs, LCA references) for claims substantiation.",
        name="Sustainability Officer",
        role="Sustainability",
        experience_years=13,
        background="ESG reporting; renewables",
        agent_description="Officer who validates environmental claims with credible metrics and sources.",
        agent_capabilities=[
    ...
    sales_director = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Aligns MQL definitions, routing SLAs, and feedback loops; ensures B2B pipeline velocity.",
        name="Sales Director (B2B)",
        role="Sales",
        experience_years=15,
        background="C&I and utility sales",
        agent_description="Sales leader who aligns pipeline definitions and keeps velocity high.",
        agent_capabilities=[
    ...
    community_ops_manager = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Supports B2C community energy enrollments; manages support flows and compliance notices.",
        name="Community Ops Manager",
        role="Community/B2C Ops",
        experience_years=7,
        background="Consumer ops; regulated programs",
        agent_description="Ops manager who scales support and compliance for community enrollments.",
        agent_capabilities=[
    ...
    stakeholder = StakeholderConfig(
        ...
        system_prompt="You are the CMO. Early phase: prioritize speed to launch. Mid: emphasize creative/brand quality and measurement integrity. Late: emphasize compliance and accessibility as reach scales.",
        model_name="o3",
        name="CMO Stakeholder",
        role="Executive",
        persona_description="Outcome-driven, brand-minded, privacy-conscious; expects crisp weekly readouts.",
        agent_description="CMO who balances launch velocity with brand integrity and privacy.",
        agent_capabilities=[
...
def create_team_timeline():
    ...
    return {
        ...
        22: [
            ("add", cfg["crm_lifecycle_manager"], "Nurture sequences and deliverability"),
        ...
        35: [
            ("add", cfg["analytics_ai"], "Experiment design reviews and MMM/MTA alignment"),
            ("add", cfg["campaign_planner_ai"], "Weekly reallocation proposals based on results"),
        ],
        45: [
            ("add", cfg["accessibility_specialist"], "Manual AA audit during scale-up"),
            ("remove", cfg["copy_optimizer_ai"], "Creative variants stabilized; focus on scaling"),
        ],
        55: [
            ("remove", cfg["media_buyer_ai"], "Automation steady-state; human pacing sufficient"),
