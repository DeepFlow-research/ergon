...
def create_workflow() -> Workflow:
    ...
    discovery_research = Task(
        ...
        description="Synthesize TAM/SAM/SOM, audience personas (utilities, municipalities, C&I, residential), buyer jobs-to-be-done, competitive scan, and channel benchmarks. Output: insights deck & JTBD map.",
    ...
    messaging_house = Task(
        ...
        description="Craft value prop ladders, proof points, and environmental claims with evidence requirements (emissions avoided, RECs, lifecycle impacts). Output: messaging house + substantiation log template.",
        status=TaskStatus.PENDING,
    ...
    channel_plan = Task(
        ...
        description="Translate strategy to channel mix (paid/owned/earned), budget allocations, geo & segment targets, and a flighting calendar with guardrails for experiments and caps.",
        status=TaskStatus.PENDING,
    ...
    creative_toolkit = Task(
        ...
        description="Produce hero/variant creatives for priority segments and channels; templates for partner co‑marketing; ensure alt text/captions and inclusive imagery. Output: asset library & spec sheets.",
        status=TaskStatus.PENDING,
    ...
    web_conversion = Task(
        ...
        description="Build/optimize campaign landing pages, calculators, and lead capture with WCAG 2.1 AA and consent management. Output: pages live with UTM taxonomy and event schema.",
        status=TaskStatus.PENDING,
    ...
    crm_enablement = Task(
        ...
        description="Configure scoring, deduplication, enrichment, and routing to Sales/Community Ops; set SLAs and feedback loop. Output: playbooks + dashboards.",
        status=TaskStatus.PENDING,
    ...
    pr_analyst = Task(
        ...
        description="Brief key media/analysts on product roadmap, case studies, and sustainability impact; embargoed press kit.",
        status=TaskStatus.PENDING,
    ...
    events_field = Task(
        ...
        description="Plan and execute industry events, webinars, and community pop-ups with lead capture kits.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=16.0,
    ...
    partner_comarketing = Task(
        ...
        description="Co-develop content and campaigns with installers, finance partners, and local programs.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=14.0,
        estimated_cost=5000.0,
    ...
    paid_media_activation = Task(
        ...
        description="Launch paid search/social/display/OOH per flighting; ensure brand safety, frequency caps, and creative rotation.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=20.0,
    ...
    email_nurture = Task(
        ...
        description="Design drip sequences by segment; respect consent preferences and enable one‑click unsubscribe.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=12.0,
        estimated_cost=3000.0,
    ...
    measurement_framework = Task(
        ...
        description="Define KPIs, brand lift study, MMM/MTA alignment, and executive dashboard; institute weekly reviews.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=16.0,
        estimated_cost=6000.0,
    ...
    experimentation_optimization = Task(
        ...
        description="Run A/B tests across LPs, ads, and nurture; implement learnings and scale winners.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=20.0,
        estimated_cost=7000.0,
        dependency_task_ids=[measurement_framework.task_id, paid_media_activation.task_id],
    )
    ...
    brand_lift_study = Task(
        ...
        description="Run brand lift with target segments; analyze aided/unaided awareness, consideration, and favorability.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=10.0,
        estimated_cost=12000.0,
    ...
    wrap_up = Task(
        ...
        description="Synthesize performance, creative insights, channel economics, and operational learnings; publish playbook and backlog for next cycle.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=12.0,
        estimated_cost=2500.0,
        dependency_task_ids=[experimentation_optimization.task_id, executive_readouts.task_id],
    )
    for task in [
        discovery_research,
        messaging_house,
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                metadata={"evidence_required": ["certifications", "LCA refs", "REC documentation"]},
            ),
            Constraint(
            ...
            Constraint(
                ...
                applicable_task_types=["Paid Media Activation", "Experimentation & Optimization"],
