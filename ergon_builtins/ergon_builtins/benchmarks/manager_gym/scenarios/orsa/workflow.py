...
def create_workflow() -> Workflow:
    ...
    governance_scope = Task(
        ...
        description="Define purpose, scope, proportionality (credit union scale), roles, and calendar. Confirm linkages to strategic plan and budget cycle; define documentation standards and audit trail requirements.",
    ...
    data_model_inventory = Task(
        ...
        description="Compile data lineage and model inventory for risk measurement and capital planning (PD/LGD/EAD, ALM/IRRBB, liquidity metrics). Identify model owners, use cases, and limitations; define validation plan.",
        status=TaskStatus.PENDING,
    ...
    risk_appetite = Task(
        ...
        description="Define risk appetite statement and limits by risk type (credit, IRRBB, liquidity, operational), with metrics, triggers, and escalation. Identify material risks and control effectiveness to derive residual risk.",
        status=TaskStatus.PENDING,
    ...
    risk_identification = Task(
        ...
        description="Cross‑functional workshops to confirm risk taxonomy: credit (retail/commercial), IRRBB, liquidity, operational, compliance, strategic, reputational, and climate risk overlay.",
        status=TaskStatus.PENDING,
    ...
    scenario_suite = Task(
        ...
        description="Design baseline, adverse, and severe scenarios; include idiosyncratic shocks and climate scenarios appropriate to size/complexity. Define variable paths and narrative.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=14.0,
        estimated_cost=4200.0,
    ...
    credit_loss_projection = Task(
        ...
        description="Project lifetime and 1‑yr losses under scenarios using PD/LGD/EAD or proxy methods; assess overlays and qualitative adjustments.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=16.0,
    ...
    liquidity_profile = Task(
        ...
        description="Assess liquidity survival horizon and funding sources; build contingency funding triggers and actions.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=12.0,
    ...
    capital_adequacy = Task(
        ...
        description="Reconcile capital under scenarios to NCUA RBC or CCULR leverage options; define management buffer and dividend/member distribution constraints.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=16.0,
        estimated_cost=4800.0,
        dependency_task_ids=[
    ...
    model_validation = Task(
        ...
        description="Execute validation/challenger tests; assess conceptual soundness, outcomes analysis, and ongoing monitoring; evidence 'effective challenge' and use‑test.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=14.0,
        estimated_cost=4200.0,
        dependency_task_ids=[
    ...
    orsa_report = Task(
        ...
        description="Draft the assessment report: methodology, scenarios, results, governance, limitations, and conclusions; include evidence index for supervisory review.",
        status=TaskStatus.PENDING,
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                metadata={
                    "evidence_required": ["inventory", "validation_reports", "monitoring_metrics"]
                },
            ),
            Constraint(
            ...
            Constraint(
                ...
                metadata={"approval_artifacts": ["minutes", "resolution", "decision_log"]},
            ),
            Constraint(
