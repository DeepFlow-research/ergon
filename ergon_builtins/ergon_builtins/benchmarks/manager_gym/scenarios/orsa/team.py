...
def create_team_configs():
    ...
    project_coordinator_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You coordinate the assessment calendar, RAID log (risks/assumptions/issues/decisions), and dependencies; maintain documentation index and version control across artifacts.",
        agent_description="Coordinator who keeps the calendar, RAID, and dependencies tight with version‑controlled artifacts.",
        agent_capabilities=[
    ...
    model_inventory_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You compile and normalize the model inventory per SR 11‑7, map inputs/outputs, controls, and monitoring; generate validation/challenger plan candidates.",
        agent_description="Inventory builder who normalizes SR 11‑7 model data and drafts validation plans.",
        agent_capabilities=[
    ...
    scenario_designer_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You draft baseline/adverse/severe macro paths, idiosyncratic shocks, and climate overlays; produce variable books and documentation suitable for governance review.",
        agent_description="Designer who crafts plausible yet severe scenarios, including climate overlays, with clear documentation.",
        agent_capabilities=[
    ...
    credit_modeler_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You assist with credit loss projections (PD/LGD/EAD or proxy), overlays, and sensitivity analysis; prepare challenger comparisons and backtests.",
        agent_description="Credit modeler who projects losses with overlay logic and backtests for credibility.",
        agent_capabilities=[
    ...
    irrbb_modeler_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You support ALM/IRRBB modeling for NII and EVE sensitivities under rate shocks/ramps; produce laddered reports and attribution notes.",
        agent_description="ALM modeler who quantifies NII/EVE and explains movements under shocks/ramps.",
        agent_capabilities=[
    ...
    liquidity_stress_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You generate liquidity stress profiles and contingency funding plan triggers; produce survival horizon analysis and funding playbooks.",
        agent_description="Liquidity modeler who derives survival horizons and actionable CFP triggers.",
        agent_capabilities=[
    ...
    operational_risk_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You summarize operational risk exposures, loss data, and scenario add‑ons; link control gaps to remediation tasks and capital add‑ons.",
        agent_description="Operational risk analyst who links loss data to control gaps and capital add‑ons.",
        agent_capabilities=[
    ...
    validator_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You assist model validation with conceptual soundness checks, outcomes analysis, and ongoing monitoring design; capture evidence of 'effective challenge'.",
        agent_description="Validation assistant who evidences conceptual soundness and outcomes analysis, and designs monitoring.",
        agent_capabilities=[
    ...
    documentation_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You compile the Internal Risk & Solvency Assessment report with citations to evidence; ensure reproducibility and audit trail completeness.",
        agent_description="Editor who compiles a traceable report with evidence links and reproducibility.",
        agent_capabilities=[
    ...
    dashboard_ai = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You build executive dashboards and board packs: key findings, capital decisions, and remediation trackers.",
        agent_description="Communicator who builds executive dashboards and board packs with decisions front‑and‑center.",
        agent_capabilities=[
    ...
    cro = HumanAgentConfig(
        ...
        system_prompt="Chief Risk Officer: owns risk framework, scenario selection, and board engagement.",
        name="Chief Risk Officer",
        role="Risk Leadership",
        experience_years=18,
        background="Enterprise risk; capital planning",
        agent_description="Risk chief who sets posture, selects scenarios, and engages the board.",
        agent_capabilities=[
    ...
    cfo = HumanAgentConfig(
        agent_id="cfo",
        agent_type="human_mock",
        system_prompt="Chief Financial Officer: aligns assessment with budget/plan; approves buffer policy.",
        name="Chief Financial Officer",
        role="Finance Leadership",
        experience_years=17,
        background="Finance; liquidity/ALM oversight",
        agent_description="Finance chief who aligns assessment with plan/budget and buffer policy.",
        agent_capabilities=[
    ...
    treasurer = HumanAgentConfig(
        agent_id="treasurer",
        agent_type="human_mock",
        system_prompt="Owns ALM/IRRBB modeling, funding strategy, and liquidity governance.",
        name="Treasurer",
        role="Treasury/ALM",
        experience_years=14,
        background="ALM/IRRBB; liquidity risk",
        agent_description="ALM owner for IRRBB and liquidity who links models to funding strategy.",
        agent_capabilities=[
    ...
    head_credit_risk = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Owns credit risk models/overlays; portfolio segmentation and loss projections.",
        name="Head of Credit Risk",
        role="Credit Risk",
        experience_years=15,
        background="Retail/Commercial credit risk",
        agent_description="Credit risk owner who validates portfolio segmentation, models, and overlays.",
        agent_capabilities=[
    ...
    liquidity_risk_manager = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Runs liquidity stress testing and contingency funding plans; coordinates with Treasurer.",
        name="Liquidity Risk Manager",
        role="Liquidity Risk",
        experience_years=10,
        background="Liquidity stress testing & funding",
        agent_description="Liquidity risk owner who runs stress testing and CFPs in lockstep with Treasury.",
        agent_capabilities=[
    ...
    orm_lead = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Owns operational risk taxonomy, loss data, KRIs, and scenario add‑ons; third‑party and fraud posture.",
        name="Operational Risk Lead",
        role="Operational Risk",
        experience_years=11,
        background="Operational risk & controls",
        agent_description="Operational risk lead who keeps taxonomy, KRIs, and scenario posture current.",
        agent_capabilities=[
    ...
    mrm_lead = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Model Risk Manager: SR 11‑7 inventory/validation; ensures effective challenge",
        name="Model Risk/Validation Lead",
        role="Model Risk",
        experience_years=12,
        background="Model validation & governance",
        agent_description="Model risk lead who ensures inventory, validation, and effective challenge.",
        agent_capabilities=[
    ...
    internal_audit = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Provides independent assurance on governance, controls, and documentation/audit trail.",
        name="Internal Audit",
        role="Assurance",
        experience_years=16,
        background="Internal audit; financial services",
        agent_description="Assurance function that validates governance, controls, and audit trail.",
        agent_capabilities=[
    ...
    board_risk_committee = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Board Risk Committee: reviews, challenges, and approves the assessment.",
        name="Board Risk Committee",
        role="Board Oversight",
        experience_years=20,
        background="Board governance",
        agent_description="Board committee that challenges, approves, and documents oversight.",
        agent_capabilities=[
    ...
    regulatory_liaison = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Coordinates with supervisors; ensures the package is exam‑ready and timely.",
        name="Regulatory Liaison",
        role="Regulatory Affairs",
        experience_years=13,
        background="Regulatory relations",
        agent_description="Liaison to supervisors who ensures exam‑ready packaging and timely communications.",
        agent_capabilities=[
    ...
    data_gov_lead = HumanAgentConfig(
        ...
        agent_type="human_mock",
        system_prompt="Owns data lineage, quality controls, and change management for risk data.",
        name="Data Governance Lead",
        role="Data Governance",
        experience_years=10,
        background="Data management & controls",
        agent_description="Data governance owner who keeps lineage, quality, and change control tight.",
        agent_capabilities=[
    ...
    stakeholder = StakeholderConfig(
        ...
        system_prompt="You are the CRO. Early: prioritize speed to stand up governance/data foundations; mid: emphasize quality of quantification and governance; late: emphasize compliance/auditability for Board sign‑off.",
        model_name="o3",
        ...
        agent_description="CRO stakeholder who sets posture early, then emphasizes quality and auditability before approval.",
        agent_capabilities=[
...
def create_team_timeline():
    ...
    return {
        0: [
            ...
            ("add", cfg["project_coordinator_ai"], "Stand up calendar, RAID, and evidence index"),
            ("add", cfg["data_governance_lead"], "Establish data lineage and QC policy"),
        ...
        5: [
            ...
            ("add", cfg["treasurer"], "Confirm ALM/IRRBB model ownership and data feeds"),
        ],
        10: [
        ...
        26: [("add", cfg["dashboard_ai"], "Build executive views for interim results")],
        30: [
            ("add", cfg["validator_ai"], "Run validation/challenger testing and monitoring design"),
            ("remove", cfg["model_inventory_ai"], "Inventory stabilized; handoff to validation"),
        ],
        35: [
        ...
        40: [
            ...
            ("add", cfg["internal_audit"], "Independent assurance on controls and audit trail"),
        ],
        45: [
            ("add", cfg["board_risk_committee"], "Board challenge and approval"),
            ("remove", cfg["scenario_designer_ai"], "Scenario set finalized; quant complete"),
        ],
        50: [
            ("add", cfg["regulatory_liaison"], "Package for exam; coordinate communications"),
            ("remove", cfg["validator_ai"], "Validation complete; monitoring plan handed off"),
        ],
    }
