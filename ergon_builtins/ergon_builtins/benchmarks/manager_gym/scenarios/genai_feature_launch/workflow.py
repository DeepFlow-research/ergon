...
from ergon_builtins.benchmarks.manager_gym.source_types import Task
from ergon_builtins.benchmarks.manager_gym.source_types import TaskStatus
from ergon_builtins.benchmarks.manager_gym.source_types import Constraint
...
def create_workflow() -> Workflow:
    ...
    product_definition = Task(
        ...
        description="Define intended use cases, task boundaries, user journeys, success metrics, and explicit out-of-scope behaviors the AI feature must refuse or route.",
    ...
    threat_modeling = Task(
        ...
        description="Comprehensive threat assessment covering prompt injection, data exfiltration, unsafe function calling, secrets exposure, and rate abuse with mapped security controls.",
        status=TaskStatus.PENDING,
    ...
    dpia_framework = Task(
        ...
        description="Complete DPIA with data flow mapping, lawful basis determination, retention policies, and third-party disclosure analysis.",
        status=TaskStatus.PENDING,
    ...
    transparency_framework = Task(
        ...
        description="Develop AI disclosures, capability documentation, content labeling, and model/system cards for user transparency and regulatory compliance.",
        status=TaskStatus.PENDING,
    ...
    safety_evaluation = Task(
        ...
        description="Comprehensive safety testing including red team scenarios, abuse testing, hallucination metrics, and jailbreak resistance with remediation tracking.",
        status=TaskStatus.PENDING,
    ...
    observability_system = Task(
        ...
        description="Implement runtime monitoring, moderation checks, event logging, alerting, and kill-switch procedures for production safety and quality assurance.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=16.0,
        estimated_cost=2400.0,
    ...
    pilot_design = Task(
        ...
        description="Design staged rollout with design partners, A/B testing framework, acceptance gates, and progressive exposure controls from internal to general availability.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=12.0,
        estimated_cost=1800.0,
    ...
    governance_package = Task(
        ...
        description="Assemble comprehensive governance documentation including decision logs, approvals, audit trails, and evidence linkage for regulatory scrutiny.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=10.0,
        estimated_cost=1500.0,
    ...
    reproducibility_docs = Task(
        ...
        description="Complete technical documentation including prompt configurations, evaluation harnesses, data lineage, and operational playbooks for incident response.",
        status=TaskStatus.PENDING,
    ...
    post_launch_plan = Task(
        ...
        description="Establish ongoing monitoring SLAs, periodic re-evaluation procedures, drift detection, and controlled update processes for models and policies.",
        status=TaskStatus.PENDING,
        estimated_duration_hours=8.0,
        estimated_cost=1200.0,
    ...
    workflow.constraints.extend(
        [
            Constraint(
                ...
                description="Comprehensive red team testing must be completed with all critical vulnerabilities remediated before launch.",
            ...
            Constraint(
                ...
                description="Data Protection Impact Assessment must be completed with documented risk acceptance before production deployment.",
            ...
            Constraint(
                ...
                description="Formal sign-offs from Product, Security, Privacy/Compliance, and Legal must be obtained before launch.",
                constraint_type="hard",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="Runtime safety monitoring, kill switches, and incident response procedures must be operational before rollout.",
                constraint_type="hard",
                enforcement_level=1.0,
            ...
            Constraint(
                ...
                description="AI disclosures, capability limitations, and content labeling must be implemented for user transparency.",
                constraint_type="regulatory",
            ...
            Constraint(
                ...
                description="Threat model must address prompt injection, data exfiltration, unsafe function calling, and rate abuse vectors.",
            ...
            Constraint(
                ...
                description="Controlled rollout must progress through internal → limited external → GA stages with defined gates.",
                constraint_type="organizational",
            ...
            Constraint(
                ...
                description="Complete audit trail with linked evidence and decision documentation must be maintained for regulatory scrutiny.",
                constraint_type="regulatory",
                enforcement_level=0.9,
                applicable_task_types=["Governance & Audit Documentation Package"],
                metadata={},
            ...
            Constraint(
                ...
                description="Safety checks must execute in ≥99% of eligible events with automated alerting for misses.",
                constraint_type="hard",
