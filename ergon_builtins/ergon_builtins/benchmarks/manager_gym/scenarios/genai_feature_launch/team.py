...
def create_team_configs():
    ...
    ai_safety_engineer = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are an AI Safety Engineer focusing on red team testing, prompt injection detection, jailbreak resistance, and adversarial robustness evaluation with automated testing frameworks.",
        agent_description="Safety engineer who pressure‑tests models under realistic adversarial conditions, builds guardrails that fail safely, and translates findings into actionable fixes.",
        agent_capabilities=[
    ...
    red_team_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Red Team Specialist conducting adversarial testing, prompt injection attacks, data exfiltration attempts, and safety violation probes with comprehensive attack scenario design.",
        agent_description="Offensive safety tester who thinks like an attacker, enumerates failure modes, and stress‑tests end‑to‑end systems.",
        agent_capabilities=[
    ...
    ml_safety_researcher = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You design hallucination detection systems, factual accuracy benchmarks, bias evaluation frameworks, and safety threshold calibration with research-backed methodologies.",
        agent_description="Research‑minded evaluator who operationalizes accuracy, bias, and robustness metrics and calibrates thresholds to policy.",
        agent_capabilities=[
    ...
    privacy_engineer = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You are a Privacy Engineer implementing data minimization, PII detection, consent management, and GDPR/CCPA compliance with privacy-by-design architecture.",
        agent_description="Engineer who bakes privacy into data flows, proving compliance with practical controls and auditable evidence.",
        agent_capabilities=[
    ...
    compliance_analyst = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You conduct DPIA assessments, regulatory mapping, data flow analysis, and AI transparency disclosure preparation with cross-jurisdictional compliance expertise.",
        agent_description="Compliance navigator who maps obligations to system reality and keeps disclosures accurate and actionable.",
        agent_capabilities=[
    ...
    security_architect = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You design threat models, implement sandboxing controls, secrets detection systems, and runtime security monitoring with defense-in-depth strategies.",
        agent_description="Pragmatic architect who hardens the system against realistic threat models and proves it with telemetry.",
        agent_capabilities=[
    ...
    devops_engineer = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You build monitoring infrastructure, alerting systems, kill switches, circuit breakers, and automated deployment pipelines with observability and incident response capabilities.",
        agent_description="Operations‑first engineer who ships reliable pipelines, rich observability, and crisp incident playbooks.",
        agent_capabilities=[
    ...
    product_manager = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You define product requirements, user journeys, success metrics, feature boundaries, and launch strategies with stakeholder coordination and market analysis.",
        agent_description="Outcome‑oriented PM who balances user value with safety and scope, keeping the team decision‑ready.",
        agent_capabilities=[
    ...
    documentation_specialist = AIAgentConfig(
        ...
        agent_type="ai",
        system_prompt="You create model cards, system documentation, user guidelines, API documentation, and audit-ready evidence packages with traceability and reproducibility focus.",
        agent_description="Documentation owner who turns complex systems into clear, auditable artifacts others can trust.",
        agent_capabilities=[
    ...
    chief_ai_officer = HumanAgentConfig(
        ...
        agent_description="Executive sponsor for responsible AI who sets guardrails, unblocks decisions, and signs off on risk posture.",
        agent_capabilities=[
    ...
    security_officer = HumanAgentConfig(
        ...
        agent_description="Security leader who insists on practical controls, measurable risk reduction, and crisp incident readiness.",
        agent_capabilities=[
    ...
    privacy_officer = HumanAgentConfig(
        ...
        agent_description="DPO who ensures lawful, proportionate data use and that user rights are respected in practice, not just on paper.",
        agent_capabilities=[
    ...
    legal_counsel = HumanAgentConfig(
        ...
        agent_description="Practical lawyer who keeps the team inside the lines while enabling speed, with crisp, defensible positions.",
        agent_capabilities=[
    ...
    product_executive = HumanAgentConfig(
        ...
        agent_description="Accountable owner for launch outcomes who reconciles value, risk, and timing and commits to decisions.",
        agent_capabilities=[
    ...
    external_auditor = HumanAgentConfig(
        ...
        agent_description="Independent assessor who pressure‑tests claims and certifies readiness with clear, reproducible checks.",
        agent_capabilities=[
    ...
    board_ethics_committee = HumanAgentConfig(
        ...
        agent_description="Oversight body that challenges assumptions, protects users, and authorizes responsible deployment.",
        agent_capabilities=[
    ...
    stakeholder = StakeholderConfig(
        ...
        system_prompt="You are the Chief Product Officer balancing AI safety, regulatory compliance, launch speed, and market competitiveness.",
        model_name="o3",
        ...
        agent_description="Executive decision‑maker who integrates product strategy with safety and compliance, and owns the launch call.",
        agent_capabilities=[
...
def create_team_timeline():
    ...
    return {
        0: [
            ("add", cfg["ai_safety_engineer"], "AI safety framework and testing infrastructure"),
            ("add", cfg["product_manager"], "Product definition and requirements"),
            ("add", cfg["security_architect"], "Threat modeling and security architecture"),
            ("add", cfg["privacy_engineer"], "Privacy by design and data protection"),
        ],
        5: [
            ("add", cfg["red_team_specialist"], "Adversarial testing and attack scenarios"),
            ("add", cfg["ml_safety_researcher"], "Hallucination detection and bias evaluation"),
            ("add", cfg["compliance_analyst"], "DPIA and regulatory compliance mapping"),
        ],
        12: [
            ("add", cfg["devops_engineer"], "Monitoring infrastructure and observability"),
            ("add", cfg["documentation_specialist"], "Model cards and audit documentation"),
        ],
        18: [
        ...
        25: [
            ...
            ("add", cfg["external_auditor"], "Independent safety audit and certification"),
        ],
        28: [("add", cfg["board_ethics_committee"], "Final ethics and responsible AI approval")],
    }
