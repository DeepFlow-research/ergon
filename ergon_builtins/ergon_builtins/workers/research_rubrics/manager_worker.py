...
_MANAGER_SYSTEM_PROMPT = (
    ...
    "Spawn a researcher sub-agent. Choose a short kebab-case task_slug "
    "(e.g. 'subq-claim-1') — it is persisted verbatim and used to identify "
    "this node. Use assigned_worker_slug='researchrubrics-researcher'.\n"
