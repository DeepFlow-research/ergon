"""Provider-specific PydanticAI capture settings for built-in LLM targets."""
...
type _CaptureSettingsResolver = Callable[[_ModelTarget, bool], JsonObject | None]
...
__all__ = ["capture_model_settings_for"]
