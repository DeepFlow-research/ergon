...
def test_benchmark_cli_metadata_exposes_setup_templates() -> None:
    metadata = benchmark_cli_metadata()
...
def test_benchmark_cli_metadata_exposes_onboarding_requirements() -> None:
    metadata = benchmark_cli_metadata()
